            ...
            <section class="dopbsp-content-wrapper">
                ...
                <div id="DOPBSP-get-features-all" class="DOPBSP-pro-tips dopbsp-left">
                    ...
                    <table class="doptable features">
                        ...
                        <p>            <a href="https://pinpoint.world/shop?utm_source=WordPress&utm_medium=Plugin%20FREE" target="_blank" class="buy"><?php echo $DOPBSP->text('WORDPRESS_BOOKING_FEATURES_BUY'); ?></a>
                                </p></td>
                        </tr>
                        <tr>
                        <td>
