                                    ...
                                    <div class="dopbsp-column-header">
                                        ...
                                        if ($DOT->get('page')
                                                && $DOPBSP->classes->backend_settings_users->permission(wp_get_current_user()->ID,
                                                                                                        'use-booking-system')){
                                            ?>
                                            <a href="javascript:DOPBSPBackEndLocation.add()" class="dopbsp-button dopbsp-add">
                                                <span class="dopbsp-info"><?php $DOT->echo($DOPBSP->text('LOCATIONS_ADD_LOCATION_SUBMIT')); ?></span>
                                            </a>
                                            <a href="<?php $DOT->echo(DOPBSP_CONFIG_HELP_DOCUMENTATION_URL,
                                                ...
                                                <span class="dopbsp-info dopbsp-help">
                                                    <?php $DOT->echo($DOPBSP->text('LOCATIONS_HELP')); ?>
                                                    <br /><br />
                                                    <?php $DOT->echo($DOPBSP->text('LOCATIONS_ADD_LOCATION_HELP')); ?>
                                                    <br /><br />
