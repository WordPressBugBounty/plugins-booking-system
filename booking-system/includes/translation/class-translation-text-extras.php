...
if (!class_exists('DOPBSPTranslationTextExtras')){
    class DOPBSPTranslationTextExtras{
        ...
        function __construct(){
            ...
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'extrasExtraDeleteGroup'));

            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'extrasExtraGroupItems'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'extrasExtraGroupItem'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'extrasExtraGroupAddItem'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'extrasExtraGroupDeleteItem'));
        ...
        function extras($text){
            $text[] = array('key'    => 'PARENT_EXTRAS',
                            'parent' => '',
                            'text'   => 'Extras');

            $text[] = array('key'    => 'EXTRAS_TITLE',
                            'parent' => 'PARENT_EXTRAS',
                            'text'   => 'Extras',
                            'de'     => 'Extras',
                            'es'     => 'Extras',
                            'fr'     => 'Suppléments');
            $text[] = array('key'    => 'EXTRAS_CREATED_BY',
                            'parent' => 'PARENT_EXTRAS',
                            'text'   => 'Created by',
                            'de'     => 'Erstellt von',
                            'es'     => 'Creada por',
                            'fr'     => 'Créé par');
            $text[] = array('key'    => 'EXTRAS_LOAD_SUCCESS',
                            'parent' => 'PARENT_EXTRAS',
                            'text'   => 'Extras list loaded.',
                            'de'     => 'Extras Liste geladen.',
                            'es'     => 'La lista de Extras cargó.',
                            'fr'     => 'La liste des suppléments est chargée.');
            $text[] = array('key'    => 'EXTRAS_NO_EXTRAS',
                            'parent' => 'PARENT_EXTRAS',
        ...
        function extrasDefault($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_DEFAULT',
                            'parent' => '',
                            'text'   => 'Extras - Default data');

            $text[] = array('key'    => 'EXTRAS_DEFAULT_PEOPLE',
                            'parent' => 'PARENT_EXTRAS_DEFAULT',
                            'text'   => 'People',
                            'de'     => 'Personen',
                            'es'     => 'Personas',
                            'fr'     => 'Personnes');
            $text[] = array('key'    => 'EXTRAS_DEFAULT_ADULTS',
                            'parent' => 'PARENT_EXTRAS_DEFAULT',
                            'text'   => 'Adults',
                            'de'     => 'Erwachsenen',
                            'es'     => 'Adultos',
                            'fr'     => 'Adultes');
            $text[] = array('key'    => 'EXTRAS_DEFAULT_CHILDREN',
                            'parent' => 'PARENT_EXTRAS_DEFAULT',
                            'text'   => 'Children',
                            'de'     => 'Kinder',
                            'es'     => 'Niños',
        ...
        function extrasExtra($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA',
                            'parent' => '',
                            'text'   => 'Extras - Extra');

            $text[] = array('key'    => 'EXTRAS_EXTRA_NAME',
                            'parent' => 'PARENT_EXTRAS_EXTRA',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'EXTRAS_EXTRA_LANGUAGE',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            'es'     => 'Idioma',
                            'fr'     => 'Langue');
            $text[] = array('key'    => 'EXTRAS_EXTRA_LOADED',
                            'parent' => 'PARENT_EXTRAS_EXTRA',
                            'text'   => 'Extra loaded.',
                            'de'     => 'Extra geladen.',
        ...
        function extrasAddExtra($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_ADD_EXTRA',
                            'parent' => '',
                            'text'   => 'Extras - Add extra');

            $text[] = array('key'    => 'EXTRAS_ADD_EXTRA_NAME',
                            'parent' => 'PARENT_EXTRAS_ADD_EXTRA',
                            'text'   => 'New extra',
                            'de'     => 'Neue extra',
                            'es'     => 'Nuevo extra',
                            'fr'     => 'Nouveau supplément');
            $text[] = array('key'    => 'EXTRAS_ADD_EXTRA_SUBMIT',
                            'parent' => 'PARENT_EXTRAS_ADD_EXTRA',
                            'text'   => 'Add extra',
                            'de'     => 'Fügen Sie extra hinzu',
                            'es'     => 'Añadir extra',
                            'fr'     => 'Ajoutez supplément');
            $text[] = array('key'    => 'EXTRAS_ADD_EXTRA_ADDING',
                            'parent' => 'PARENT_EXTRAS_ADD_EXTRA',
            ...
            $text[] = array('key'    => 'EXTRAS_ADD_EXTRA_SUCCESS',
                            'parent' => 'PARENT_EXTRAS_ADD_EXTRA',
        ...
        function extrasDeleteExtra($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_DELETE_EXTRA',
                            'parent' => '',
                            'text'   => 'Extras - Delete extra');

            $text[] = array('key'    => 'EXTRAS_DELETE_EXTRA_CONFIRMATION',
            ...
            $text[] = array('key'    => 'EXTRAS_DELETE_EXTRA_SUBMIT',
                            'parent' => 'PARENT_EXTRAS_DELETE_EXTRA',
                            'text'   => 'Delete extra',
                            'de'     => 'Löschen von extra',
                            'es'     => 'Suprima extra',
                            'fr'     => 'Supprimez le supplément');
            $text[] = array('key'    => 'EXTRAS_DELETE_EXTRA_DELETING',
                            'parent' => 'PARENT_EXTRAS_DELETE_EXTRA',
                            'text'   => 'Deleting extra ...',
                            'de'     => 'Löschen von extra ...',
                            'es'     => 'Supresión extra...',
                            'fr'     => 'Suppression de supplémentaire ...');
            $text[] = array('key'    => 'EXTRAS_DELETE_EXTRA_SUCCESS',
                            'parent' => 'PARENT_EXTRAS_DELETE_EXTRA',
        ...
        function extrasExtraGroups($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_GROUPS',
                            'parent' => '',
                            'text'   => 'Extras - Extra groups');

            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUPS',
        ...
        function extrasExtraGroup($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_GROUP',
                            'parent' => '',
                            'text'   => 'Extras - Extra group');

            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_SHOW_SETTINGS',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
                            'text'   => 'Show settings',
                            'de'     => 'Einstellungen anzeigen',
                            'es'     => 'Muestre los ajustes',
                            'fr'     => 'Montrez les parametres');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_HIDE_SETTINGS',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
                            'text'   => 'Hide settings',
                            'de'     => 'Einstellungen ausblenden',
                            'es'     => 'Oculte los ajustes',
                            'fr'     => 'Cachez les paramètres');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_SORT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
                            'text'   => 'Sort',
                            'de'     => 'Sortieren',
                            'es'     => 'Ordenar',
             ...
             * Settings labels.
             */
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_LABEL_LABEL',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
                            'text'   => 'Label',
                            'de'     => 'Etikett',
                            'es'     => 'Etiqueta',
                            'fr'     => 'Étiquette');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_REQUIRED_LABEL',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
                            'text'   => 'Required',
                            'de'     => 'Erforderlich',
                            'es'     => 'Necesario',
                            'fr'     => 'Nécessaire');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_NO_ITEMS_MULTIPLY_LABEL',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_MULTIPLE_SELECT_LABEL',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP',
        ...
        function extrasExtraAddGroup($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_ADD_GROUP',
                            'parent' => '',
                            'text'   => 'Extras - Add extra group');

            $text[] = array('key'    => 'EXTRAS_EXTRA_ADD_GROUP_SUBMIT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_ADD_GROUP',
                            'text'   => 'Add group',
                            'de'     => 'Gruppe hinzufügen',
                            'es'     => 'Añada grupo',
                            'fr'     => 'Ajoutez un groupe');
            $text[] = array('key'    => 'EXTRAS_EXTRA_ADD_GROUP_LABEL',
                            'parent' => 'PARENT_EXTRAS_EXTRA_ADD_GROUP',
                            'text'   => 'New group',
                            'de'     => 'Neue Gruppe',
                            'es'     => 'Nuevo grupo',
                            'fr'     => 'Nouveau groupe');
            $text[] = array('key'    => 'EXTRAS_EXTRA_ADD_GROUP_ADDING',
                            'parent' => 'PARENT_EXTRAS_EXTRA_ADD_GROUP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_ADD_GROUP_SUCCESS',
                            'parent' => 'PARENT_EXTRAS_EXTRA_ADD_GROUP',
        ...
        function extrasExtraDeleteGroup($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_DELETE_GROUP',
                            'parent' => '',
                            'text'   => 'Extras - Delete extra group');

            $text[] = array('key'    => 'EXTRAS_EXTRA_DELETE_GROUP_CONFIRMATION',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_DELETE_GROUP_SUBMIT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_DELETE_GROUP',
                            'text'   => 'Delete',
                            'de'     => 'Löschen',
                            'es'     => 'Borrar',
                            'fr'     => 'Supprimer');
            $text[] = array('key'    => 'EXTRAS_EXTRA_DELETE_GROUP_DELETING',
                            'parent' => 'PARENT_EXTRAS_EXTRA_DELETE_GROUP',
                            'text'   => 'Deleting extra group ...',
                            'de'     => 'Extra Gruppe wird gelöscht ...',
                            'es'     => 'Supresión de grupo extra',
                            'fr'     => 'Suppression de groupe supplémentaire ...');
            $text[] = array('key'    => 'EXTRAS_EXTRA_DELETE_GROUP_SUCCESS',
                            'parent' => 'PARENT_EXTRAS_EXTRA_DELETE_GROUP',
        ...
        function extrasExtraGroupItems($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_GROUP_ITEMS',
                            'parent' => '',
                            'text'   => 'Extras - Extra group - Items');

            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_LABEL',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_LABELS_LABEL',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEMS',
                            'text'   => 'Label',
                            'de'     => 'Etikett',
                            'es'     => 'Etiqueta',
                            'fr'     => 'Étiquette');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_LABELS_OPERATION',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEMS',
                            'text'   => 'Operation',
                            'de'     => 'Vorgang',
                            'es'     => 'Operación',
                            'fr'     => 'Opération');//1
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_LABELS_PRICE',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEMS',
                            'text'   => 'Price/Percent',
                            'de'     => 'Preis/Prozent',
                            'es'     => 'Precio/Por ciento',
                            'fr'     => 'Prix/Pour cent');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_LABELS_PRICE_TYPE',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEMS',
                            'text'   => 'Price type',
                            'de'     => 'Preistyp',
                            'es'     => 'Tipo de precios',
                            'fr'     => 'Type des prix');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_LABELS_PRICE_BY',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEMS',
                            'text'   => 'Price by',
                            'de'     => 'Preis von',
                            'es'     => 'Precio por',
                            'fr'     => 'Prix par');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_LABELS_DEFAULT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEMS',
                            'text'   => 'Set as default',
        ...
        function extrasExtraGroupItem($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'parent' => '',
                            'text'   => 'Extras - Extra group - Item');

            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_PRICE_TYPE_FIXED',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'text'   => 'Fixed',
                            'de'     => 'Fest',
                            'es'     => 'Fijo',
                            'fr'     => 'Fixe');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_PRICE_TYPE_PERCENT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'text'   => 'Percent',
                            'de'     => 'Prozent',
                            'es'     => 'Por ciento',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_PRICE_BY_ONCE',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'text'   => 'Once',
                            'de'     => 'Einmal',
                            'es'     => 'Una vez',
                            'fr'     => 'Une fois');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_PRICE_BY_PERIOD',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'text'   => 'day/hour',
                            'de'     => 'tag/stunde',
                            'es'     => 'día/hora',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEM_SORT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'text'   => 'Sort',
                            'de'     => 'Sortieren',
                            'es'     => 'Ordenar',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_DEFAULT_NO',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'text'   => 'No',
                            'de'     => 'Nein',
                            'es'     => 'No',
                            'fr'     => 'No');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_DEFAULT_YES',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ITEM',
                            'text'   => 'Yes',
                            'de'     => 'Ja',
                            'es'     => 'Sí',
        ...
        function extrasExtraGroupAddItem($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_GROUP_ADD_ITEM',
                            'parent' => '',
                            'text'   => 'Extras - Extra group - Add item');

            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ADD_ITEM_LABEL',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ADD_ITEM',
                            'text'   => 'New item',
                            'de'     => 'Neues Element',
                            'es'     => 'Nuevo artículo',
                            'fr'     => 'nouvel élément');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ADD_ITEM_SUBMIT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ADD_ITEM',
                            'text'   => 'Add item',
                            'de'     => 'Element hinzufügen',
                            'es'     => 'Añada el artículo',
                            'fr'     => 'Ajouter un élément');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ADD_ITEM_ADDING',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ADD_ITEM',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ADD_ITEM_SUCCESS',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_ADD_ITEM',
        ...
        function extrasExtraGroupDeleteItem($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_EXTRA_GROUP_DELETE_ITEM',
                            'parent' => '',
                            'text'   => 'Extras - Extra group - Delete item');

            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_DELETE_ITEM_CONFIRMATION',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_DELETE_ITEM_SUBMIT',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_DELETE_ITEM',
                            'text'   => 'Delete',
                            'de'     => 'Löschen',
                            'es'     => 'Borrar',
                            'fr'     => 'Supprimer');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_DELETE_ITEM_DELETING',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_DELETE_ITEM',
                            'text'   => 'Deleting  item ...',
                            'de'     => 'Element wird gelöscht...',
                            'es'     => 'Supresión de artículo...',
                            'fr'     => 'Suppression d<<single-quote>>élément...');
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_DELETE_ITEM_SUCCESS',
                            'parent' => 'PARENT_EXTRAS_EXTRA_GROUP_DELETE_ITEM',
        ...
        function extrasHelp($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_HELP',
                            'parent' => '',
                            'text'   => 'Extras - Help');

            $text[] = array('key'    => 'EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_ADD_EXTRA_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_ADD_GROUP_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_EDIT_GROUP_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_DELETE_GROUP_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_SORT_GROUP_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
             ...
             * Extra group help.
             */
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_LABEL_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_REQUIRED_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_MULTIPLE_SELECT_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_NO_ITEMS_MULTIPLY_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
            ...
            $text[] = array('key'    => 'EXTRAS_EXTRA_GROUP_ITEMS_HELP',
                            'parent' => 'PARENT_EXTRAS_HELP',
        ...
        function extrasFrontEnd($text){
            $text[] = array('key'    => 'PARENT_EXTRAS_FRONT_END',
                            'parent' => '',
                            'text'   => 'Extras - Front end');

            $text[] = array('key'      => 'EXTRAS_FRONT_END_TITLE',
                            ...
                            'fr'       => 'Suppléments',
                            'location' => 'all');
            $text[] = array('key'      => 'EXTRAS_FRONT_END_BY_DAY',
                            'parent'   => 'PARENT_EXTRAS_FRONT_END',
                            'text'     => 'day',
                            'de'       => 'tag',
                            'es'       => 'día',
                            'fr'       => 'jour',
                            'location' => 'all');
            $text[] = array('key'      => 'EXTRAS_FRONT_END_BY_HOUR',
                            'parent'   => 'PARENT_EXTRAS_FRONT_END',
                            'text'     => 'hour',
                            'de'       => 'stunde',
                            'es'       => 'hora',
                            'fr'       => 'heure',
                            'location' => 'all');
            $text[] = array('key'      => 'EXTRAS_FRONT_END_INVALID',
                            'parent'   => 'PARENT_EXTRAS_FRONT_END',
