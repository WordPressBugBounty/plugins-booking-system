...
if (!class_exists('DOPBSPTranslationTextTools')){
    class DOPBSPTranslationTextTools{
        ...
        function __construct(){
            ...
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'toolsRepairDatabaseText'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'toolsRepairSearchSettings'));
        }
         ...
         */
        function tools($text){
            $text[] = array('key'    => 'PARENT_TOOLS',
                            'parent' => '',
                            'text'   => 'Tools');

            $text[] = array('key'    => 'TOOLS_TITLE',
                            'parent' => 'PARENT_TOOLS',
                            'text'   => 'Tools',
                            'de'     => 'Werkzeuge',
                            'es'     => 'Herramientas',
        ...
        function toolsHelp($text){
            $text[] = array('key'    => 'PARENT_TOOLS_HELP',
                            'parent' => '',
                            'text'   => 'Tools - Help');

            $text[] = array('key'    => 'TOOLS_HELP',
        ...
        function toolsRepairCalendarsSettings($text){
            $text[] = array('key'    => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
                            'parent' => '',
                            'text'   => 'Tools - Repair calendars settings');

            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_TITLE',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_CONFIRMATION',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_REPAIRING',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_SUCCESS',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_CALENDARS',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
                            'text'   => 'Calendars',
                            'de'     => 'Kalendern',
                            'es'     => 'Calendarios',
                            'fr'     => 'Calendriers');
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_SETTINGS_DATABASE',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
                            'text'   => 'Settings database',
                            'de'     => 'Einstellungsdatenbank',
                            'es'     => 'Base de datos de ajustes',
                            'fr'     => 'Base de données de paramètres');
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_NOTIFICATIONS_DATABASE',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
                            'text'   => 'Notifications database',
                            'de'     => 'Benachrichtigungs Datenbank',
                            'es'     => 'Notifications database',
                            'fr'     => 'Base de données de notifications');
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_PAYMENT_DATABASE',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_UNCHANGED',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
                            'text'   => 'Unchanged',
                            'de'     => 'Unverändert',
                            'es'     => 'Sin modificar',
                            'fr'     => 'Inchangé');
            $text[] = array('key'    => 'TOOLS_REPAIR_CALENDARS_SETTINGS_REPAIRED',
                            'parent' => 'PARENT_TOOLS_REPAIR_CALENDARS_SETTINGS',
                            'text'   => 'Repaired',
                            'de'     => 'Repariert',
                            'es'     => 'Reparado',
        ...
        function toolsRepairDatabaseText($text){
            $text[] = array('key'    => 'PARENT_TOOLS_REPAIR_DATABASE_TEXT',
                            'parent' => '',
                            'text'   => 'Tools - Repair database & text');

            $text[] = array('key'    => 'TOOLS_REPAIR_DATABASE_TEXT_TITLE',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_DATABASE_TEXT_CONFIRMATION',
                            'parent' => 'PARENT_TOOLS_REPAIR_DATABASE_TEXT',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_DATABASE_TEXT_REPAIRING',
                            'parent' => 'PARENT_TOOLS_REPAIR_DATABASE_TEXT',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_DATABASE_TEXT_SUCCESS',
                            'parent' => 'PARENT_TOOLS_REPAIR_DATABASE_TEXT',
        ...
        function toolsRepairSearchSettings($text){
            $text[] = array('key'    => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
                            'parent' => '',
                            'text'   => 'Tools - Repair search settings');

            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_TITLE',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_CONFIRMATION',
                            'parent' => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_REPAIRING',
                            'parent' => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_SUCCESS',
                            'parent' => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
                            'text'   => 'The settings have been repaired.',
                            'de'     => 'Die Einstellungen wurden repariert.',
                            'es'     => 'Los ajustes han sido reparados.',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_SEARCHES',
                            'parent' => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
                            'text'   => 'Searches',
                            'de'     => 'Suchen',
                            'es'     => 'Búsquedas',
                            'fr'     => 'Recherches');
            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_SETTINGS_DATABASE',
                            'parent' => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
                            'text'   => 'Settings database',
                            'de'     => 'Einstellungsdatenbank',
                            'es'     => 'Base de datos de ajustes',
            ...
            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_UNCHANGED',
                            'parent' => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
                            'text'   => 'Unchanged',
                            'de'     => 'Unverändert',
                            'es'     => 'Inalterado',
                            'fr'     => 'Inchangé');
            $text[] = array('key'    => 'TOOLS_REPAIR_SEARCH_SETTINGS_REPAIRED',
                            'parent' => 'PARENT_TOOLS_REPAIR_SEARCH_SETTINGS',
                            'text'   => 'Repaired',
                            'de'     => 'Repariert',
                            'es'     => 'Reparado',
