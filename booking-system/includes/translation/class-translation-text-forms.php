...
if (!class_exists('DOPBSPTranslationTextForms')){
    class DOPBSPTranslationTextForms{
        ...
        function __construct(){
            ...
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'formsFormDeleteField'));

            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'formsFormFieldSelectOptions'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'formsFormFieldSelectOption'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'formsFormFieldSelectAddOption'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'formsFormFieldSelectDeleteOption'));
         ...
         */
        function forms($text){
            $text[] = array('key'    => 'PARENT_FORMS',
                            'parent' => '',
                            'text'   => 'Forms');

            $text[] = array('key'    => 'FORMS_TITLE',
                            'parent' => 'PARENT_FORMS',
                            'text'   => 'Forms',
                            'de'     => 'Formularen',
                            'es'     => 'Formularios',
                            'fr'     => 'Formulaire');
            $text[] = array('key'    => 'FORMS_CREATED_BY',
                            'parent' => 'PARENT_FORMS',
                            'text'   => 'Created by',
                            'de'     => 'Erstellt von',
                            'es'     => 'Creada por',
                            'fr'     => 'Créé par');
            $text[] = array('key'    => 'FORMS_LOAD_SUCCESS',
                            'parent' => 'PARENT_FORMS',
                            'text'   => 'Forms list loaded.',
                            'de'     => 'Formularliste geladen.',
                            'es'     => 'La lista de Formularios cargó.',
                            'fr'     => 'Liste de formulaires chargée');
            $text[] = array('key'    => 'FORMS_NO_FORMS',
                            'parent' => 'PARENT_FORMS',
        ...
        function formsDefault($text){
            $text[] = array('key'    => 'PARENT_FORMS_DEFAULT',
                            'parent' => '',
                            'text'   => 'Forms - Default data');

            $text[] = array('key'      => 'FORMS_DEFAULT_NAME',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'FORMS_DEFAULT_FIRST_NAME',
                            'parent'   => 'PARENT_FORMS_DEFAULT',
                            'text'     => 'First name',
                            'de'       => 'Vorname',
                            'es'       => 'Nombre',
                            'fr'       => 'Prenom',
                            'location' => 'all');
            $text[] = array('key'      => 'FORMS_DEFAULT_LAST_NAME',
                            'parent'   => 'PARENT_FORMS_DEFAULT',
                            'text'     => 'Last name',
                            'de'       => 'Nachname',
                            'es'       => 'Apellido',
                            'fr'       => 'Nom',
                            'location' => 'all');
            $text[] = array('key'      => 'FORMS_DEFAULT_EMAIL',
                            'parent'   => 'PARENT_FORMS_DEFAULT',
                            'text'     => 'Email',
                            'de'       => 'E-Mail',
                            ...
                            'fr'       => 'Email',
                            'location' => 'all');
            $text[] = array('key'      => 'FORMS_DEFAULT_PHONE',
                            'parent'   => 'PARENT_FORMS_DEFAULT',
                            'text'     => 'Phone',
                            'de'       => 'Telefon',
                            'es'       => 'Teléfono',
                            'fr'       => 'Téléphone',
                            'location' => 'all');
            $text[] = array('key'      => 'FORMS_DEFAULT_MESSAGE',
                            'parent'   => 'PARENT_FORMS_DEFAULT',
                            'text'     => 'Message',
                            'de'       => 'Nachricht',
                            'es'       => 'Mensaje',
        ...
        function formsForm($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM',
                            'parent' => '',
                            'text'   => 'Forms - Form');

            $text[] = array('key'    => 'FORMS_FORM_NAME',
                            'parent' => 'PARENT_FORMS_FORM',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'FORMS_FORM_LANGUAGE',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            'es'     => 'Idioma',
                            'fr'     => 'Langue');
            $text[] = array('key'    => 'FORMS_FORM_LOADED',
                            'parent' => 'PARENT_FORMS_FORM',
                            'text'   => 'Form loaded.',
                            'de'     => 'Formular geladen.',
                            'es'     => 'Formulario cargó.',
        ...
        function formsAddForm($text){
            $text[] = array('key'    => 'PARENT_FORMS_ADD_FORM',
                            'parent' => '',
                            'text'   => 'Forms - Add form');

            $text[] = array('key'    => 'FORMS_ADD_FORM_NAME',
                            'parent' => 'PARENT_FORMS_ADD_FORM',
                            'text'   => 'New form',
                            'de'     => 'Neues Formular',
                            'es'     => 'Nuevo formulario',
                            'fr'     => 'Nouveau formulaire');
            $text[] = array('key'    => 'FORMS_ADD_FORM_SUBMIT',
                            'parent' => 'PARENT_FORMS_ADD_FORM',
                            'text'   => 'Add form',
                            'de'     => 'Formular hinzufügen',
                            'es'     => 'Añada formulario',
                            'fr'     => 'Ajoutez un formulaire');
            $text[] = array('key'    => 'FORMS_ADD_FORM_ADDING',
                            'parent' => 'PARENT_FORMS_ADD_FORM',
            ...
            $text[] = array('key'    => 'FORMS_ADD_FORM_SUCCESS',
                            'parent' => 'PARENT_FORMS_ADD_FORM',
        ...
        function formsDeleteForm($text){
            $text[] = array('key'    => 'PARENT_FORMS_DELETE_FORM',
                            'parent' => '',
                            'text'   => 'Forms - Delete form');

            $text[] = array('key'    => 'FORMS_DELETE_FORM_CONFIRMATION',
        ...
        function formsFormFields($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM_FIELDS',
                            'parent' => '',
                            'text'   => 'Forms - Form fields');

            $text[] = array('key'    => 'FORMS_FORM_FIELDS',
        ...
        function formsFormField($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM_FIELD',
                            'parent' => '',
                            'text'   => 'Forms - Form field');

            $text[] = array('key'    => 'FORMS_FORM_FIELD_SHOW_SETTINGS',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Show settings',
                            'de'     => 'Einstellungen anzeigen',
                            'es'     => 'Muestre los ajustes',
                            'fr'     => 'Montrez les paramètres');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_HIDE_SETTINGS',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Hide settings',
                            'de'     => 'Einstellungen ausblenden',
                            'es'     => 'Oculte los ajustes',
                            'fr'     => 'Cachez les fixations');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SORT',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Sort',
                            'de'     => 'Sortieren',
                            'es'     => 'Ordenar',
             ...
             * Field types.
             */
            $text[] = array('key'    => 'FORMS_FORM_FIELD_TYPE_TEXT_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Text',
                            'de'     => 'Text',
                            'es'     => 'Text',
                            'fr'     => 'Text');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_TYPE_TEXTAREA_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Textarea',
                            'de'     => 'Textarea',
                            'es'     => 'Textarea',
                            'fr'     => 'Textarea');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_TYPE_CHECKBOX_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Checkbox',
                            'de'     => 'Checkbox',
                            'es'     => 'Checkbox',
                            'fr'     => 'Checkbox');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_TYPE_CHECKBOX_CHECKED_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Checked',
                            'de'     => 'Überprüft',
                            'es'     => 'Marcada',
                            ...
                            'nl'     => 'Gecontroleerd',
                            'pl'     => 'Wybrane');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_TYPE_CHECKBOX_UNCHECKED_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Unchecked',
                            'de'     => 'Ungeprüft',
                            'es'     => 'Non marcada',
                            ...
                            'nl'     => 'Ongehinderd',
                            'pl'     => 'Niewybrane');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_TYPE_SELECT_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Drop down',
                            'de'     => 'Dropdown',
                            'es'     => 'Dropdown',
             ...
             * Settings labels.
             */
            $text[] = array('key'    => 'FORMS_FORM_FIELD_LABEL_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Label',
                            'de'     => 'Etikett',
                            'es'     => 'Etiqueta',
                            'fr'     => 'Étiquette');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_ALLOWED_CHARACTERS_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Allowed Characters',
                            'de'     => 'Zulässigen Zeichen',
                            'es'     => 'Carácteres permitidos',
                            'fr'     => 'Caractères autorisés');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SIZE_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Size',
                            'de'     => 'Größe',
                            'es'     => 'Dimensión',
                            'fr'     => 'Dimension');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_EMAIL_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Is email',
                            'de'     => 'Ist E-Mail',
                            'es'     => 'Es correo electrónico',
                            'fr'     => 'Est email');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_PHONE_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Is phone',
                            'de'     => 'Ist Telefon',
                            'es'     => 'Es teléfono',
                            'fr'     => 'C<<single-quote>>est téléphoné');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_DEFAULT_COUNTRY_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Default country',
                            'de'     => 'Standard Land',
                            'es'     => 'País por defecto',
                            'fr'     => 'Pays par défaut');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_REQUIRED_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Required',
                            'de'     => 'Erforderlich',
                            'es'     => 'Necesario',
                            'fr'     => 'Requis');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_MULTIPLE_SELECT_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
                            'text'   => 'Multiple select',
                            'de'     => 'Mehrfachauswahl',
                            'es'     => 'Múltiple escogido',
                            'fr'     => 'Sélection multiple');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_ADD_TO_DAY_HOUR_INFO_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_ADD_TO_DAY_HOUR_BODY_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
        ...
        function formsFormAddField($text){
            ...
            $text[] = array('key'    => 'FORMS_FORM_ADD_FIELD_ADDING',
                            'parent' => 'PARENT_FORMS_FORM_ADD_FIELD',
            ...
            $text[] = array('key'    => 'FORMS_FORM_ADD_FIELD_SUCCESS',
                            'parent' => 'PARENT_FORMS_FORM_ADD_FIELD',
        ...
        function formsFormDeleteField($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM_DELETE_FIELD',
                            'parent' => '',
                            'text'   => 'Forms - Delete form field');

            $text[] = array('key'    => 'FORMS_FORM_DELETE_FIELD_CONFIRMATION',
            ...
            $text[] = array('key'    => 'FORMS_FORM_DELETE_FIELD_SUBMIT',
                            'parent' => 'PARENT_FORMS_FORM_DELETE_FIELD',
                            'text'   => 'Delete',
                            'de'     => 'Löschen',
                            'es'     => 'Borrar',
                            'fr'     => 'Supprimer');
            $text[] = array('key'    => 'FORMS_FORM_DELETE_FIELD_DELETING',
                            'parent' => 'PARENT_FORMS_FORM_DELETE_FIELD',
            ...
            $text[] = array('key'    => 'FORMS_FORM_DELETE_FIELD_SUCCESS',
                            'parent' => 'PARENT_FORMS_FORM_DELETE_FIELD',
        ...
        function formsFormFieldSelectOptions($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM_FIELD_SELECT_OPTIONS',
                            'parent' => '',
                            'text'   => 'Forms - Form field - Select options');

            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_OPTIONS_LABEL',
        ...
        function formsFormFieldSelectOption($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM_FIELD_SELECT_OPTION',
                            'parent' => '',
                            'text'   => 'Forms - Form field - Select option');

            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_OPTION_SORT',
        ...
        function formsFormFieldSelectAddOption($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM_FIELD_SELECT_ADD_OPTION',
                            'parent' => '',
                            'text'   => 'Forms - Form field - Add select option');

            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_ADD_OPTION_LABEL',
                            'parent' => 'PARENT_FORMS_FORM_FIELD_SELECT_ADD_OPTION',
                            'text'   => 'New option',
                            'de'     => 'Neue Option',
                            'es'     => 'Nueva opción',
                            'fr'     => 'Nouvelle option');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_ADD_OPTION_SUBMIT',
                            'parent' => 'PARENT_FORMS_FORM_FIELD_SELECT_ADD_OPTION',
                            'text'   => 'Add select option',
                            'de'     => 'Option hinzufügen',
                            'es'     => 'Añadir opción para selección',
                            'fr'     => 'Ajouter une option de sélection');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_ADD_OPTION_ADDING',
                            'parent' => 'PARENT_FORMS_FORM_FIELD_SELECT_ADD_OPTION',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_ADD_OPTION_SUCCESS',
                            'parent' => 'PARENT_FORMS_FORM_FIELD_SELECT_ADD_OPTION',
        ...
        function formsFormFieldSelectDeleteOption($text){
            $text[] = array('key'    => 'PARENT_FORMS_FORM_FIELD_SELECT_DELETE_OPTION',
                            'parent' => '',
                            'text'   => 'Forms - Form field - Delete select option');

            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_DELETE_OPTION_CONFIRMATION',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_DELETE_OPTION_SUBMIT',
                            'parent' => 'PARENT_FORMS_FORM_FIELD_SELECT_DELETE_OPTION',
                            'text'   => 'Delete',
                            'de'     => 'Löschen',
                            'es'     => 'Borrar',
                            'fr'     => 'Supprimer');
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_DELETE_OPTION_DELETING',
                            'parent' => 'PARENT_FORMS_FORM_FIELD_SELECT_DELETE_OPTION',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_DELETE_OPTION_SUCCESS',
                            'parent' => 'PARENT_FORMS_FORM_FIELD_SELECT_DELETE_OPTION',
        ...
        function formsHelp($text){
            $text[] = array('key'    => 'PARENT_FORMS_HELP',
                            'parent' => '',
                            'text'   => 'Forms - Help');

            $text[] = array('key'    => 'FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_ADD_FORM_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_ADD_FIELD_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_EDIT_FIELD_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_DELETE_FIELD_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_SORT_FIELD_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
             ...
             * Form field help.
             */
            $text[] = array('key'    => 'FORMS_FORM_FIELD_LABEL_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_ALLOWED_CHARACTERS_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SIZE_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_EMAIL_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_PHONE_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_DEFAULT_COUNTRY',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_REQUIRED_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_MULTIPLE_SELECT_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_ADD_TO_DAY_HOUR_INFO_HELP',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_ADD_TO_DAY_HOUR_BODY_HELP',
                            'parent' => 'PARENT_FORMS_FORM_FIELD',
            ...
            $text[] = array('key'    => 'FORMS_FORM_FIELD_SELECT_OPTIONS_HELP',
                            'parent' => 'PARENT_FORMS_HELP',
        ...
        function formsFrontEnd($text){
            $text[] = array('key'    => 'PARENT_FORMS_FRONT_END',
                            'parent' => '',
                            'text'   => 'Forms - Front end');

            $text[] = array('key'      => 'FORMS_FRONT_END_TITLE',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'FORMS_FRONT_END_REQUIRED',
                            'parent'   => 'PARENT_FORMS_FRONT_END',
                            'text'     => 'is required.',
                            'de'       => 'erforderlich.',
                            'es'       => 'es necesario',
                            ...
                            'pl'       => 'wymagane.',
                            'location' => 'all');
            $text[] = array('key'      => 'FORMS_FRONT_END_INVALID_EMAIL',
                            'parent'   => 'PARENT_FORMS_FRONT_END',
