...
if (!class_exists('DOPBSPTranslationTextLanguages')){
    class DOPBSPTranslationTextLanguages{
        ...
        function languages($text){
            ...
            $text[] = array('key'    => 'LANGUAGES_SET_SUCCESS',
                            'parent' => 'PARENT_LANGUAGES',
            ...
            $text[] = array('key'    => 'LANGUAGES_REMOVE_CONFIGURATION',
                            'parent' => 'PARENT_LANGUAGES',
            ...
            $text[] = array('key'    => 'LANGUAGES_REMOVING',
                            'parent' => 'PARENT_LANGUAGES',
            ...
            $text[] = array('key'    => 'LANGUAGES_REMOVE_SUCCESS',
                            'parent' => 'PARENT_LANGUAGES',
        ...
        function languagesHelp($text){
            $text[] = array('key'    => 'PARENT_LANGUAGES_HELP',
                            'parent' => '',
                            'text'   => 'Languages - Help');

            $text[] = array('key'    => 'LANGUAGES_HELP',
