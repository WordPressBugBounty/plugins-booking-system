...
if (!class_exists('DOPBSPTranslationTextCoupons')){
    class DOPBSPTranslationTextCoupons{
        ...
        function coupons($text){
            $text[] = array('key'    => 'PARENT_COUPONS',
                            'parent' => '',
                            'text'   => 'Coupons');

            $text[] = array('key'    => 'COUPONS_TITLE',
                            'parent' => 'PARENT_COUPONS',
                            'text'   => 'Coupons',
                            'de'     => 'Coupons',
                            'es'     => 'Cupones',
                            'fr'     => 'Coupons');
            $text[] = array('key'    => 'COUPONS_CREATED_BY',
                            'parent' => 'PARENT_COUPONS',
                            'text'   => 'Created by',
                            'de'     => 'Erstellt von',
                            'es'     => 'Creada por',
                            'fr'     => 'Créé par');
            $text[] = array('key'    => 'COUPONS_LOAD_SUCCESS',
                            'parent' => 'PARENT_COUPONS',
                            'text'   => 'Coupons list loaded.',
                            'de'     => 'Coupon-Liste geladen.',
                            'es'     => 'La lista de cupones cargó.',
                            'fr'     => 'La liste de coupons a chargé.');
            $text[] = array('key'    => 'COUPONS_NO_COUPONS',
                            'parent' => 'PARENT_COUPONS',
        ...
        function couponsCoupon($text){
            $text[] = array('key'    => 'PARENT_COUPONS_COUPON',
                            'parent' => '',
                            'text'   => 'Coupons - Coupon');

            $text[] = array('key'    => 'COUPONS_COUPON_NAME',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'COUPONS_COUPON_LANGUAGE',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            'es'     => 'Idioma',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_LABEL',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Label',
                            'de'     => 'Etikett',
                            'es'     => 'Etiqueta',
                            'fr'     => 'Étiquette');
            $text[] = array('key'    => 'COUPONS_COUPON_CODE',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Code',
                            'de'     => 'Code',
                            'es'     => 'Código',
                            'fr'     => 'Code');
            $text[] = array('key'    => 'COUPONS_COUPON_CODE_GENERATE',
                            'parent' => 'PARENT_COUPONS_COUPON',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_START_DATE',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Start date',
                            'de'     => 'Startdatum',
                            'es'     => 'Fecha de inicio',
                            'fr'     => 'Date de début');
            $text[] = array('key'    => 'COUPONS_COUPON_END_DATE',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'End date',
                            'de'     => 'Enddatum',
                            'es'     => 'Fecha final',
                            'fr'     => 'Date de fin');
            $text[] = array('key'    => 'COUPONS_COUPON_START_HOUR',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Start hour',
                            'de'     => 'Startstunde',
                            'es'     => 'Hora de principio',
                            'fr'     => 'Heure de début');
            $text[] = array('key'    => 'COUPONS_COUPON_END_HOUR',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'End hour',
                            'de'     => 'Endstunde',
                            'es'     => 'Hora de final',
                            'fr'     => 'Heure de fin');
            $text[] = array('key'    => 'COUPONS_COUPON_NO_COUPONS',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Number of coupons',
                            'de'     => 'Anzahl der Coupons',
                            'es'     => 'número de cupones',
                            'fr'     => 'Nombre de coupons');
            $text[] = array('key'    => 'COUPONS_COUPON_OPERATION',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Operation',
                            'de'     => 'Vorgang',
                            'es'     => 'Operación',
                            'fr'     => 'Opération');
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Price/Percent',
                            'de'     => 'Preis/Prozent',
                            'es'     => 'Precio/Por ciento',
                            'fr'     => 'Prix/Pourcentage');
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE_TYPE',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Price type',
                            'de'     => 'Preistyp',
                            'es'     => 'Tipo de precios',
                            'fr'     => 'Type des prix');
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE_TYPE_FIXED',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Fixed',
                            'de'     => 'Fest',
                            'es'     => 'Fijo',
                            'fr'     => 'Fixé');
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE_TYPE_PERCENT',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Percent',
                            'de'     => 'Prozent',
                            'es'     => 'Por ciento',
                            'fr'     => 'Pourcentage');
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE_BY',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Price by',
                            'de'     => 'Preis von',
                            'es'     => 'Precio por',
                            'fr'     => 'Prix par');
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE_BY_ONCE',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Once',
                            'de'     => 'Einmal',
                            'es'     => 'Una vez',
                            'fr'     => 'Une fois');
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE_BY_PERIOD',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'day/hour',
                            'de'     => 'tag/stunde',
                            'es'     => 'día/hora',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_LOADED',
                            'parent' => 'PARENT_COUPONS_COUPON',
                            'text'   => 'Coupon loaded.',
                            'de'     => 'Coupon geladen.',
                            'es'     => 'El cupón cargó.',
        ...
        function couponsAddCoupon($text){
            $text[] = array('key'    => 'PARENT_COUPONS_ADD_COUPON',
                            'parent' => '',
                            'text'   => 'Coupons - Add coupon');

            $text[] = array('key'    => 'COUPONS_ADD_COUPON_NAME',
                            'parent' => 'PARENT_COUPONS_ADD_COUPON',
                            'text'   => 'New coupon',
                            'de'     => 'Neuer Gutschein',
                            'es'     => 'Nuevo cupón',
                            'fr'     => 'Nouveau coupon');
            $text[] = array('key'    => 'COUPONS_ADD_COUPON_LABEL',
                            'parent' => 'PARENT_COUPONS_ADD_COUPON',
                            'text'   => 'Coupon',
                            'de'     => 'Coupon',
                            'es'     => 'Cupón',
                            'fr'     => 'Coupon');
            $text[] = array('key'    => 'COUPONS_ADD_COUPON_SUBMIT',
                            'parent' => 'PARENT_COUPONS_ADD_COUPON',
                            'text'   => 'Add coupon',
                            'de'     => 'Coupon hinzufügen',
                            'es'     => 'Añada cupón',
                            'fr'     => 'Ajoutez le coupon');
            $text[] = array('key'    => 'COUPONS_ADD_COUPON_ADDING',
                            'parent' => 'PARENT_COUPONS_ADD_COUPON',
            ...
            $text[] = array('key'    => 'COUPONS_ADD_COUPON_SUCCESS',
                            'parent' => 'PARENT_COUPONS_ADD_COUPON',
        ...
        function couponsDeleteCoupon($text){
            $text[] = array('key'    => 'PARENT_COUPONS_DELETE_COUPON',
                            'parent' => '',
                            'text'   => 'Coupons - Delete coupon');

            $text[] = array('key'    => 'COUPONS_DELETE_COUPON_CONFIRMATION',
            ...
            $text[] = array('key'    => 'COUPONS_DELETE_COUPON_SUBMIT',
                            'parent' => 'PARENT_COUPONS_DELETE_COUPON',
                            'text'   => 'Delete coupon',
                            'de'     => 'Coupon löschen',
                            'es'     => 'Suprima cupón',
                            'fr'     => 'Supprimez coupon');
            $text[] = array('key'    => 'COUPONS_DELETE_COUPON_DELETING',
                            'parent' => 'PARENT_COUPONS_DELETE_COUPON',
                            'text'   => 'Deleting coupon ...',
                            'de'     => 'Coupon wird gelöscht ...',
                            'es'     => 'Supresión de cupón...',
                            'fr'     => 'Supprimer le coupon ...');
            $text[] = array('key'    => 'COUPONS_DELETE_COUPON_SUCCESS',
                            'parent' => 'PARENT_COUPONS_DELETE_COUPON',
        ...
        function couponsHelp($text){
            $text[] = array('key'    => 'PARENT_COUPONS_HELP',
                            'parent' => '',
                            'text'   => 'Coupons - Help');

            $text[] = array('key'    => 'COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_ADD_COUPON_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
             ...
             * Coupon help.
             */
            $text[] = array('key'    => 'COUPONS_COUPON_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_LABEL_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_END_DATE_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_START_HOUR_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_END_HOUR_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_NO_COUPONS_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_OPERATION_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
            ...
            $text[] = array('key'    => 'COUPONS_COUPON_PRICE_BY_HELP',
                            'parent' => 'PARENT_COUPONS_HELP',
        ...
        function couponsFrontEnd($text){
            $text[] = array('key'    => 'PARENT_COUPONS_FRONT_END',
                            'parent' => '',
                            'text'   => 'Coupons - Front end');

            $text[] = array('key'      => 'COUPONS_FRONT_END_TITLE',
            ...
            $text[] = array('key'      => 'COUPONS_FRONT_END_CODE',
                            'parent'   => 'PARENT_COUPONS_FRONT_END',
                            'text'     => 'Enter code',
                            'de'       => 'Code eingeben',
                            ...
                            'fr'       => 'Entrez le code',
                            'location' => 'all');
            $text[] = array('key'      => 'COUPONS_FRONT_END_VERIFY',
                            'parent'   => 'PARENT_COUPONS_FRONT_END',
                            'text'     => 'Verify code',
                            'de'       => 'Code überprüfen',
                            'es'       => 'Verifique código',
                            'fr'       => 'Vérifiez le code',
                            'location' => 'all');
            $text[] = array('key'      => 'COUPONS_FRONT_END_VERIFY_SUCCESS',
                            'parent'   => 'PARENT_COUPONS_FRONT_END',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'COUPONS_FRONT_END_VERIFY_ERROR',
                            'parent'   => 'PARENT_COUPONS_FRONT_END',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'COUPONS_FRONT_END_USE',
                            'parent'   => 'PARENT_COUPONS_FRONT_END',
                            'text'     => 'Use coupon',
            ...
            $text[] = array('key'      => 'COUPONS_FRONT_END_BY_DAY',
                            'parent'   => 'PARENT_COUPONS_FRONT_END',
                            'text'     => 'day',
                            'de'       => 'tag',
                            'es'       => 'día',
                            'fr'       => 'jour',
                            'location' => 'all');
            $text[] = array('key'      => 'COUPONS_FRONT_END_BY_HOUR',
                            'parent'   => 'PARENT_COUPONS_FRONT_END',
                            'text'     => 'hour',
                            'de'       => 'stunde',
                            'es'       => 'hora',
