...
if (!class_exists('DOPBSPTranslationTextFees')){
    class DOPBSPTranslationTextFees{
         ...
         */
        function fees($text){
            $text[] = array('key'      => 'PARENT_FEES',
                            'parent'   => '',
                            'text'     => 'Taxes & fees',
                            'location' => 'all');

            $text[] = array('key'      => 'FEES_TITLE',
                            'parent'   => 'PARENT_FEES',
                            'text'     => 'Taxes & fees',
                            ...
                            'fr'       => 'Taxes & frais',
                            'location' => 'all');
            $text[] = array('key'      => 'FEES_CREATED_BY',
                            'parent'   => 'PARENT_FEES',
                            'text'     => 'Created by',
                            'de'       => 'Erstellt von',
                            'es'       => 'Creada por',
                            'fr'       => 'Créé par',
                            'location' => 'all');
            $text[] = array('key'    => 'FEES_LOAD_SUCCESS',
                            'parent' => 'PARENT_FEES',
        ...
        function feesFee($text){
            $text[] = array('key'    => 'PARENT_FEES_FEE',
                            'parent' => '',
                            'text'   => 'Taxes & fees - Tax or fee');

            $text[] = array('key'    => 'FEES_FEE_NAME',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'FEES_FEE_LANGUAGE',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            'es'     => 'Idioma',
            ...
            $text[] = array('key'    => 'FEES_FEE_LABEL',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Label',
                            'de'     => 'Etikett',
                            'es'     => 'Etiqueta',
                            'fr'     => 'Étiquette');
            $text[] = array('key'    => 'FEES_FEE_OPERATION',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Operation',
                            'de'     => 'Vorgang',
                            'es'     => 'Operación',
                            'fr'     => 'Operation');
            $text[] = array('key'    => 'FEES_FEE_PRICE',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Price/Percent',
                            'de'     => 'Preis/Prozent',
                            'es'     => 'Precio/Por ciento',
                            'fr'     => 'Prix/pour cent');
            $text[] = array('key'    => 'FEES_FEE_PRICE_TYPE',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Price type',
                            'de'     => 'Preistyp',
                            'es'     => 'Tipo de precios',
                            'fr'     => 'Prix type');
            $text[] = array('key'    => 'FEES_FEE_PRICE_TYPE_FIXED',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Fixed',
                            'de'     => 'Fest',
                            'es'     => 'Fijo',
                            'fr'     => 'Fixe');
            $text[] = array('key'    => 'FEES_FEE_PRICE_TYPE_PERCENT',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Percent',
                            'de'     => 'Prozent',
                            'es'     => 'Por ciento',
                            'fr'     => 'Pour cent');
            $text[] = array('key'    => 'FEES_FEE_PRICE_BY',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Price by',
                            'de'     => 'Preis von',
                            'es'     => 'Precio por',
                            'fr'     => 'Prix par');
            $text[] = array('key'    => 'FEES_FEE_PRICE_BY_ONCE',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Once',
                            'de'     => 'Einmal',
                            'es'     => 'Una vez',
                            'fr'     => 'Une fois');
            $text[] = array('key'    => 'FEES_FEE_PRICE_BY_PERIOD',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'day/hour',
                            'de'     => 'tag/stunde',
                            'es'     => 'día/hora',
                            'fr'     => 'jour/heure');
            $text[] = array('key'    => 'FEES_FEE_INCLUDED',
                            'parent' => 'PARENT_FEES_FEE',
                            'text'   => 'Included',
                            'de'     => 'Einbezogen',
                            'es'     => 'Incluido',
                            'fr'     => 'Inclus');
            $text[] = array('key'    => 'FEES_FEE_EXTRAS',
                            'parent' => 'PARENT_FEES_FEE',
            ...
            $text[] = array('key'    => 'FEES_FEE_LOADED',
                            'parent' => 'PARENT_FEES_FEE',
        ...
        function feesAddFee($text){
            ...
            $text[] = array('key'    => 'FEES_ADD_FEE_SUCCESS',
                            'parent' => 'PARENT_FEES_ADD_FEE',
        ...
        function feesDeleteFee($text){
            $text[] = array('key'    => 'PARENT_FEES_DELETE_FEE',
                            'parent' => '',
                            'text'   => 'Taxes & fees - Delete tax or fee');

            $text[] = array('key'    => 'FEES_DELETE_FEE_CONFIRMATION',
        ...
        function feesHelp($text){
            $text[] = array('key'    => 'PARENT_FEES_HELP',
                            'parent' => '',
                            'text'   => 'Taxes & fees - Help');

            $text[] = array('key'    => 'FEES_HELP',
            ...
            $text[] = array('key'    => 'FEES_ADD_FEE_HELP',
                            'parent' => 'PARENT_FEES_HELP',
            ...
            $text[] = array('key'    => 'FEES_FEE_NAME_HELP',
                            'parent' => 'PARENT_FEES_HELP',
            ...
            $text[] = array('key'    => 'FEES_FEE_LANGUAGE_HELP',
                            'parent' => 'PARENT_FEES_HELP',
            ...
            $text[] = array('key'    => 'FEES_FEE_LABEL_HELP',
                            'parent' => 'PARENT_FEES_HELP',
            ...
            $text[] = array('key'    => 'FEES_FEE_OPERATION_HELP',
                            'parent' => 'PARENT_FEES_FEE',
            ...
            $text[] = array('key'    => 'FEES_FEE_PRICE_HELP',
                            'parent' => 'PARENT_FEES_FEE',
            ...
            $text[] = array('key'    => 'FEES_FEE_PRICE_TYPE_HELP',
                            'parent' => 'PARENT_FEES_FEE',
            ...
            $text[] = array('key'    => 'FEES_FEE_PRICE_BY_HELP',
                            'parent' => 'PARENT_FEES_FEE',
            ...
            $text[] = array('key'    => 'FEES_FEE_INCLUDED_HELP',
                            'parent' => 'PARENT_FEES_FEE',
            ...
            $text[] = array('key'    => 'FEES_FEE_EXTRAS_HELP',
                            'parent' => 'PARENT_FEES_FEE',
            ...
            $text[] = array('key'    => 'FEES_FEE_CART_HELP',
                            'parent' => 'PARENT_FEES_FEE',
        ...
        function feesFrontEnd($text){
            $text[] = array('key'    => 'PARENT_FEES_FRONT_END',
                            'parent' => '',
                            'text'   => 'Fees - Front end');

            $text[] = array('key'      => 'FEES_FRONT_END_TITLE',
                            ...
                            'fr'       => 'Taxes & frais',
                            'location' => 'all');
            $text[] = array('key'      => 'FEES_FRONT_END_BY_DAY',
                            'parent'   => 'PARENT_FEES_FRONT_END',
                            'text'     => 'day',
                            'de'       => 'tag',
                            'es'       => 'día',
                            'fr'       => 'jour',
                            'location' => 'all');
            $text[] = array('key'      => 'FEES_FRONT_END_BY_HOUR',
                            'parent'   => 'PARENT_FEES_FRONT_END',
                            'text'     => 'hour',
                            'de'       => 'Stunde',
                            'es'       => 'hora',
                            'fr'       => 'heure',
                            'location' => 'all');
            $text[] = array('key'      => 'FEES_FRONT_END_INCLUDED',
                            'parent'   => 'PARENT_FEES_FRONT_END',
