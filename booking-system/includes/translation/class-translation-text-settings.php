    ...
    class DOPBSPTranslationTextSettings{
        ...
        function __construct(){
            /*
                 ...
                 */
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'settings'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
        ...
        function settings($text){
            $text[] = array('key'    => 'PARENT_SETTINGS',
                            'parent' => '',
                            'text'   => 'Settings');

            $text[] = array('key'    => 'SETTINGS_TITLE',
            ...
            $text[] = array('key'    => 'SETTINGS_ENABLED',
                            'parent' => 'PARENT_SETTINGS',
                            'text'   => 'Enabled',
                            'de'     => 'Aktiviert',
                            'es'     => 'Activado',
                            'fr'     => 'Activé');
            $text[] = array('key'    => 'SETTINGS_DISABLED',
                            'parent' => 'PARENT_SETTINGS',
                            'text'   => 'Disabled',
                            'de'     => 'Deaktiviert',
                            'es'     => 'Desactivado',
            ...
            $text[] = array('key'    => 'SETTINGS_GENERAL_TITLE',
                            'parent' => 'PARENT_SETTINGS',
            ...
            $text[] = array('key'    => 'SETTINGS_GENERAL_GOOGLE_MAP_API_KEY',
                            'parent' => 'PARENT_SETTINGS',
            ...
            $text[] = array('key'    => 'SETTINGS_GENERAL_REFERRAL_ID',
                            'parent' => 'PARENT_SETTINGS',
                            'text'   => 'Referral ID',
                            'de'     => 'Empfehlung-ID',
                            'es'     => 'Remisión ID',
            ...
            $text[] = array('key'    => 'SETTINGS_GENERAL_REFERRAL_DISPLAY',
                            'parent' => 'PARENT_SETTINGS',
        ...
        function settingsHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_HELP',
                            'parent' => '',
                            'text'   => 'Settings - Help');

            $text[] = array('key'    => 'SETTINGS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_GENERAL_GOOGLE_MAP_API_KEY_HELP',
                            'parent' => 'PARENT_SETTINGS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_GENERAL_REFERRAL_ID_HELP',
                            'parent' => 'PARENT_SETTINGS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_GENERAL_REFERRAL_DISPLAY_HELP',
                            'parent' => 'PARENT_SETTINGS_HELP',
        ...
        function settingsCalendar($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_CALENDAR',
                            'parent' => '',
                            'text'   => 'Settings - Calendar');

            $text[] = array('key'    => 'SETTINGS_CALENDAR_TITLE',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_NAME',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
            ...
            /*
                 * General settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'General settings',
                            'de'     => 'Allgemeine Einstellungen',
                            'es'     => 'Configuración General',
                            'fr'     => 'Paramètres généraux');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_DATE_TYPE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Date type',
                            'de'     => 'Datentyp',
                            'es'     => 'Tipo de fecha',
                            'fr'     => 'Type de date');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_DATE_TYPE_AMERICAN',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'American (mm dd, yyyy)',
                            'de'     => 'Amerikanisch (MM.TT.JJJJ)',
                            'es'     => 'Americano (mm dd, aaaa)',
                            'fr'     => 'Américain (mm jj, aaaa)');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_DATE_TYPE_EUROPEAN',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'European (dd mm yyyy)',
                            'de'     => 'Europa (TT MM JJJJ)',
                            'es'     => 'Europea (dd mm aa)',
                            'fr'     => 'Européen (jj mm aaaa)');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_TEMPLATE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Style template',
                            'de'     => 'Stilvorlage',
                            'es'     => 'Plantilla de estilo',
                            'fr'     => 'Modèle de style');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_BOOKING_STOP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_MONTHS_NO',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Number of months displayed',
                            'de'     => 'Anzahl der angezeigten Monate',
                            'es'     => 'Número de meses mostrados',
                            'fr'     => 'Nombre de mois affichés');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_VIEW_ONLY',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'View only info',
                            'de'     => 'Nur Informationen anzeigen',
                            'es'     => 'Vea sólo la información',
                            'fr'     => 'Voyez seulement des infos');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_SERVER_TIME',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Enable server time',
                            'de'     => 'Serverzeit aktivieren',
                            'es'     => 'Permita el tiempo de servidor',
                            'fr'     => 'Permettez le temps de serveur');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_TIMEZONE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Timezone',
                            'de'     => 'Zeitzone',
                            'es'     => 'Huso horario',
                            'fr'     => 'Fuseau horaire');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_HIDE_PRICE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Hide price',
                            'de'     => 'Preis ausblenden',
                            'es'     => 'Precio de puesto',
                            'fr'     => 'Prix de cachette');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_HIDE_NO_AVAILABLE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Hide No available',
                            'de'     => 'Nr ausblenden verfügbar',
                            'es'     => 'Ocultar el número disponible',
                            'fr'     => 'Masquer le nombre disponible');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_MINIMUM_NO_AVAILABLE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Minimum no available',
                            'de'     => 'Mindestanzahl verfügbar',
                            'es'     => 'Número mínimo disponible',
                            'fr'     => 'Nombre minimal disponible');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_MAXIMUM_NO_AVAILABLE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Maximum no available',
                            'de'     => 'Maximale Anzahl verfügbar',
                            'es'     => 'Número máximo disponible',
                            'fr'     => 'Nombre maximum disponible');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_POST_ID',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Post ID',
                            'de'     => 'Beitrag ID',
            ...
            /*
                 * Currency settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Currency settings',
                            'de'     => 'Währungseinstellungen',
                            'es'     => 'Ajustes monetarios',
                            'fr'     => 'Paramètres de monnaie');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Currency',
                            'de'     => 'Währung',
                            'es'     => 'Moneda',
                            'fr'     => 'Monnaie');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_POSITION',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Currency position',
                            'de'     => 'Währungsposition',
                            'es'     => 'Posición monetaria',
                            'fr'     => 'Position de monnaie');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_POSITION_BEFORE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Before',
                            'de'     => 'Vorher',
                            'es'     => 'Antes',
                            'fr'     => 'Avant');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_POSITION_BEFORE_WITH_SPACE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Before with space',
                            'de'     => 'Vorher mit Leerzeichen',
                            'es'     => 'Antes con espacio',
                            'fr'     => 'Auparavant avec espace');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_POSITION_AFTER',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'After',
                            'de'     => 'Nachher',
                            'es'     => 'Después',
                            'fr'     => 'Après');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_POSITION_AFTER_WITH_SPACE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            /*
                 * Hours settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Hours settings',
                            'de'     => 'Stundeneinstellungen',
                            'es'     => 'Ajustes de horas',
                            'fr'     => 'Paramètres d<<single-quote>>heures');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Use hours',
                            'de'     => 'Verwenden stunden',
                            'es'     => 'Horas de empleo',
                            'fr'     => 'Utilisez les heures');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_INFO_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_DEFINITIONS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Define hours',
                            'de'     => 'Stunden definieren',
                            'es'     => 'Defina horas',
                            'fr'     => 'Définissez des heures');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_MULTIPLE_SELECT',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_AMPM',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Enable AM/PM format',
                            'de'     => 'Aktivieren Sie das AM/PM-Format',
                            'es'     => 'Habilitar formato AM/PM',
                            'fr'     => 'Activer le format AM/PM');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_ADD_LAST_HOUR_TO_TOTAL_PRICE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_INTERVAL_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_INTERVAL_AUTOBREAK_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            /*
                 * Sidebar settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_SIDEBAR_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Sidebar settings',
                            'de'     => 'Seitenleiste Einstellungen',
                            'es'     => 'Sidebar ajustes',
                            'fr'     => 'Paramètres de sidebar');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_SIDEBAR_STYLE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Sidebar style',
                            'de'     => 'Stil der Seitenleiste',
                            'es'     => 'Sidebar estilo',
                            'fr'     => 'Style de sidebar');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_SIDEBAR_NO_ITEMS_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            /*
                 * Rules settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_RULES_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Rules settings',
                            'de'     => 'Regeleinstellungen',
                            'es'     => 'Ajustes de reglas',
                            'fr'     => 'Paramètres de règles');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_RULES',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Select rule',
                            'de'     => 'Regel auswählen',
                            'es'     => 'Seleccione la regla',
                            'fr'     => 'Choisissez la règle');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_RULES_NONE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'None',
                            'de'     => 'Keine',
                            'es'     => 'Ninguno',
            ...
            /*
                 * Cart settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CART_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Cart settings',
                            'de'     => 'Warenkorb einstellungen',
                            'es'     => 'Ajustes de carro',
                            'fr'     => 'Paramètres de chariot');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CART_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Enable cart',
            ...
            /*
                 * Taxes & fees settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_FEES_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_FEES',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            /*
                 * Deposit settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Deposit settings',
                            'de'     => 'Einzahlung Einstellungen',
                            'es'     => 'Ajustes de depósito',
                            'fr'     => 'Paramètres de dépôt');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Deposit value',
                            'de'     => 'Einzahlungswert',
                            'es'     => 'Valor de depósito',
                            'fr'     => 'Valeur de dépôt');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_TYPE',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Deposit type',
                            'de'     => 'Einzahlungs art',
                            'es'     => 'Tipo de depósito',
                            'fr'     => 'Type de dépôt');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_TYPE_FIXED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Fixed',
                            'de'     => 'Fest',
                            'es'     => 'Fijo',
                            'fr'     => 'Fixé');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_TYPE_PERCENT',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Percent',
                            'de'     => 'Prozent',
                            'es'     => 'Por ciento',
                            'fr'     => 'Pour cent');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_PAY_FULL_AMOUNT',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            /*
                 * Forms ssettings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_FORMS_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Forms settings',
                            'de'     => 'Formulareinstellungen',
                            'fr'     => 'Ajustes de formas');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_FORMS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Select form',
            ...
            /*
                 * Order settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Order settings',
                            'de'     => 'Auftragseinstellungen',
                            'es'     => 'Ajustes de orden',
                            'fr'     => 'Les paramètres d<<single-quote>>ordre');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_TERMS_AND_CONDITIONS_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_TERMS_AND_CONDITIONS_LINK',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Terms & Conditions link',
                            'de'     => 'Link "Geschäftsbedingungen"',
                            'es'     => 'Enlace a los términos y condiciones',
                            'fr'     => 'Lien vers les termes et conditions');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_PRIVACY_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Enable Privacy Policy',
                            'de'     => 'Datenschutzrichtlinie aktivieren',
                            'es'     => 'Activar la política de privacidad',
                            'fr'     => 'Activer la politique de confidentialité');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_PRIVACY_LINK',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Privacy Policy link',
                            'de'     => 'Link zur Datenschutzrichtlinie',
                            'es'     => 'Enlace a la política de privacidad',
                            'fr'     => 'Lien vers la politique de confidentialité');
            /*
                 * Google Calendar Sync settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_SYNC_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_CLIENT_ID',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Client ID',
                            'de'     => 'Kunden-ID',
                            'es'     => 'Cliente ID',
                            'fr'     => 'ID de client');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_PROJECT_ID',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Project ID',
                            'de'     => 'Project ID',
                            'es'     => 'Project ID',
                            'fr'     => 'Project ID');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_CLIENT_SECRET',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Client secret',
                            'de'     => 'Kunden geheimnis',
                            'es'     => 'Secreto de cliente',
                            'fr'     => 'Secret de client');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_CALENDAR_ID',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Calendar ID',
                            'de'     => 'Kalender-ID',
                            'es'     => 'Calendario ID',
                            'fr'     => 'ID de calendrier');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_FEED_URL',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Feed URL',
                            'de'     => 'Feed URL',
                            'es'     => 'URL del feed',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_CALENDAR_ID',
                            ...
                            'es'     => 'Calendar ID',
                            'fr'     => 'Calendar ID');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_TOKEN_URI',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Token URI',
                            'de'     => 'Token URI',
                            'es'     => 'Token URI',
                            'fr'     => 'Token URI');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_SYNC_TIME',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Sync time',
                            'de'     => 'Synchronisierungszeit',
                            'es'     => 'Tiempo de sincronización',
                            'fr'     => 'Temps synchro');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_SYNC_TIMEOUT',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Sync timeout',
            ...
            /*
                 * iCAL Sync settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_SYNC_SETTINGS',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ICAL_URL',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'iCalendar URL',
                            'de'     => 'iCalendar URL',
                            'es'     => 'iCalendar URL',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_SYNC_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_ENABLED',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_FEED_URL',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Feed URL',
                            'de'     => 'Feed URL',
                            'es'     => 'URL del feed',
                            'fr'     => 'URL du flux');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_SYNC_TIME',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Sync time',
                            'de'     => 'Synchronisierungszeit',
                            'es'     => 'Tiempo de sincronización',
                            'fr'     => 'Sync temps');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_SYNC_TIMEOUT',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
                            'text'   => 'Sync timeout',
                            'de'     => 'Synchronisierungszeitlimit',
                            'es'     => 'Interrupción de sincronización',
        ...
        function settingsCalendarHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'parent' => '',
                            'text'   => 'Settings - Calendar - Help');

            $text[] = array('key'    => 'SETTINGS_CALENDAR_NAME_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * General settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_DATE_TYPE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            ...
                            'fr'     => 'Changez le nom de calendrier.');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_TEMPLATE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_BOOKING_STOP_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_MONTHS_NO_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_VIEW_ONLY_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_SERVER_TIME_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_TIMEZONE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'Select your timezone.',
                            'de'     => 'Wählen Sie Ihre Zeitzone aus.',
                            'es'     => 'Seleccione su timezone.',
                            'fr'     => 'Choisissez votre timezone.');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_HIDE_PRICE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_HIDE_NO_AVAILABLE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_MINIMUM_NO_AVAILABLE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_MAXIMUM_NO_AVAILABLE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'Default value: 1000. Set maximum no available from sidebar ( frontend ).',
                            'de'     => 'Standardwert: 1000. Legen Sie die maximale Anzahl der verfügbaren Seitenleisten fest ( Frontend ).',
                            'es'     => 'Valor predeterminado: 1. Establecer mínimo no disponible en la barra lateral ( frontend ).',
                            'fr'     => 'Valeur par défaut : 1. Définissez le nombre minimum de non disponible dans la barre latérale ( frontend ).');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GENERAL_POST_ID_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CURRENCY_POSITION_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * Days settings help.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DAYS_MULTIPLE_SELECT_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DAYS_AVAILABLE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DAYS_FIRST_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DAYS_FIRST_DISPLAYED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DAYS_MORNING_CHECK_OUT_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DAYS_DETAILS_FROM_HOURS_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * Hours settings help.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_INFO_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_DEFINITIONS_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_MULTIPLE_SELECT_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_AMPM_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_ADD_LAST_HOUR_TO_TOTAL_PRICE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_INTERVAL_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_HOURS_INTERVAL_AUTOBREAK_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_SIDEBAR_STYLE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_SIDEBAR_NO_ITEMS_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * Rules settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_RULES_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_EXTRAS_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * Cart settings help.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_CART_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DISCOUNTS_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_FEES_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_COUPONS_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_TYPE_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_DEPOSIT_PAY_FULL_AMOUNT_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * Forms settings help.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_FORMS_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * Order settings help.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_TERMS_AND_CONDITIONS_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_TERMS_AND_CONDITIONS_LINK_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_PRIVACY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'Default value: Disabled. Enable Privacy Policy check box.',
                            'de'     => 'Standardwert: Deaktiviert. Aktivieren Sie das Kontrollkästchen Datenschutzrichtlinie.',
                            'es'     => 'Valor predeterminado: Discapacitado. Active la casilla de verificación de la política de privacidad.',
                            'fr'     => 'Valeur par défaut : Désactivé. Activez la case à cocher Politique de confidentialité.');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ORDER_PRIVACY_LINK_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'Enter the link to Privacy Policy page.',
                            'de'     => 'Geben Sie den Link zur Seite mit den Datenschutzrichtlinien ein.',
                            'es'     => 'Introduzca el enlace a la página de Política de Privacidad.',
                            'fr'     => 'Saisissez le lien vers la page de la politique de confidentialité.');
            /*
                 * Google Calendar Sync settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_CALENDAR_ID_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_FEED_URL_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_SYNC_TIME_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_SYNC_TIMEOUT_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_GOOGLE_CALENDAR_SYNC_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'Synchronize',
                            'de'     => 'Synchronisieren',
                            'es'     => 'Sincronizar',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_ICAL_URL_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            /*
                 * Airbnb Sync settings.
                 */
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_FEED_URL_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_SYNC_TIME_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'Sync calendar at every x seconds.',
                            'de'     => 'Synchronisieren Sie den Kalender alle x Sekunden.',
                            'es'     => 'Calendario de sincronización cada x segundos.',
                            'fr'     => 'Synchroniser le calendrier toutes les x secondes.');
            $text[] = array('key'    => 'SETTINGS_CALENDAR_AIRBNB_SYNC_TIMEOUT_HELP',
                            'parent' => 'PARENT_SETTINGS_CALENDAR_HELP',
                            'text'   => 'Stop sync after x seconds if is not finished.',
                            'de'     => 'Beenden Sie die Synchronisierung nach x Sekunden, wenn nicht abgeschlossen ist.',
                            'es'     => 'Deje de sincronizar después de x segundos si no está terminado.',
        ...
        function settingsNotifications($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'parent' => '',
                            'text'   => 'Settings - Notifications');

            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TITLE',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEMPLATES',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Email templates',
                            'de'     => 'E-Mail-Vorlagen',
                            'es'     => 'Plantillas de Email',
                            'fr'     => 'Modèles de courrier électronique');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_METHOD_ADMIN',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_METHOD_USER',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_ADMIN_EMAIL_SENDER',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            /*
                 * Send notifications.
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_TITLE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_ADMIN',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_USER',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_WITH_APPROVAL_ADMIN',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_WITH_APPROVAL_USER',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_APPROVED',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_CANCELED',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_REJECTED',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            /*
                 * SMTP settings.
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMTP_TITLE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'SMTP settings',
                            'de'     => 'SMTP-Einstellungen',
                            'es'     => 'SMTP ajustes',
                            'fr'     => 'Paramètres de SMTP');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMTP_SECOND_TITLE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            /*
                 * Test
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_TITLE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_METHOD',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_EMAIL',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Test email',
                            'de'     => 'Test-E-Mail',
                            'es'     => 'Email de prueba',
                            'fr'     => 'Courrier électronique de test');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_SUBMIT',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Send test',
                            'de'     => 'Test senden',
                            'es'     => 'Envíe prueba',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_SENDING',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_SUCCESS',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_ERROR',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_MAIL_SUBJECT',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_MAIL_MESSAGE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_MAILER_SUBJECT',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_MAILER_MESSAGE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_SMTP_SUBJECT',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_SMTP_MESSAGE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_SMTP2_SUBJECT',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_SMTP2_MESSAGE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_WP_SUBJECT',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_WP_MESSAGE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_TITLE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_ACCOUNT_TYPE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Account type',
                            'de'     => 'Kontotyp',
                            'es'     => 'Tipo de cuenta',
                            'fr'     => 'Type de compte');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_USERNAME',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Username',
                            'de'     => 'Benutzername',
                            'es'     => 'Nombre de usuario',
                            'fr'     => 'Nom d<<single-quote>>utilisateur');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_PASSWORD',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Password',
                            'de'     => 'Kennwort',
                            'es'     => 'Contraseña',
                            'fr'     => 'Mot de passe');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_API_ID',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'API',
                            'de'     => 'API',
                            'es'     => 'API',
                            'fr'     => 'API');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_FROM',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'From',
                            'de'     => 'Von',
                            'es'     => 'De',
                            'fr'     => 'De');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_ADMIN_PHONE',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Notifications phone',
                            'de'     => 'Benachrichtigung Telefon',
                            'es'     => 'Teléfono de notificaciones',
                            'fr'     => 'Téléphone de notifications');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_TEMPLATES',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'SMS templates',
                            'de'     => 'SMS-Vorlagen',
                            'es'     => 'Plantillas de SMS',
                            'fr'     => 'Modèles SMS');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_2WAY',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Enable 2 Way option',
                            'de'     => '2-Wege-Option einschalten',
                            'es'     => 'Activar la opción de 2 Vías',
                            'fr'     => 'Activer l<<single-quote>>option à 2 Voies');
        ...
        function settingsNotificationsHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
                            'parent' => '',
                            'text'   => 'Settings - Notifications - Help');

            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEMPLATES_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_METHOD_ADMIN_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_METHOD_USER_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL_REPLY_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_ADMIN_EMAIL_SENDER_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL_NAME_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL_CC_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL_CC_NAME_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL_BCC_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_EMAIL_BCC_NAME_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            /*
                 * Send notifications.
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_ADMIN_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_USER_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_WITH_APPROVAL_ADMIN_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_BOOK_WITH_APPROVAL_USER_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_APPROVED_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_CANCELED_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SEND_REJECTED_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            /*
                 * SMTP
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMTP_HOST_NAME_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMTP_PASSWORD_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            /*
                 * Test
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_METHOD_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_TEST_EMAIL_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            /*
                 * SMS notifications - Clickatell.com
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_ACCOUNT_TYPE_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_USERNAME_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_PASSWORD_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_API_ID_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_FROM_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_ADMIN_PHONE_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_ADMIN_PHONE_ADD_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Add phone number.',
                            'de'     => 'Telefonnummer hinzufügen.',
                            'es'     => 'Añada el número de teléfono.',
                            'fr'     => 'Ajoutez le numéro de téléphone.');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_TEMPLATES_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'SMS templates',
                            'de'     => 'SMS-Vorlagen',
                            'es'     => 'Plantillas de SMS',
                            'fr'     => 'Modèles SMS');
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_CLICKATELL_2WAY_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS',
                            'text'   => 'Enable this option if you have Clickatell configured to use a 2 way number.',
                            'de'     => 'Aktivieren Sie diese Option, wenn Sie Clickatell für die Verwendung einer 2-Wege-Nummer konfiguriert haben.',
                            'es'     => 'Active esta opción si tiene configurado Clickatell para utilizar un número de 2 vías.',
                            'fr'     => 'Activez cette option si vous avez configuré Clickatell pour utiliser un numéro à 2 voies.');

            /*
                 * Send notifications.
                 */
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_SEND_BOOK_ADMIN_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_SEND_BOOK_USER_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_SEND_BOOK_WITH_APPROVAL_ADMIN_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_SEND_BOOK_WITH_APPROVAL_USER_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_SEND_APPROVED_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_SEND_CANCELED_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_NOTIFICATIONS_SMS_SEND_REJECTED_HELP',
                            'parent' => 'PARENT_SETTINGS_NOTIFICATIONS_HELP',
        ...
        function settingsPaymentGateways($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'parent' => '',
                            'text'   => 'Settings - Payment gateways');

            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_TITLE',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYMENT_ARRIVAL_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYMENT_ARRIVAL_WITH_APPROVAL_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYMENT_REDIRECT',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
            ...
            /*
                 * Add-ons redirection
                 */
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDONS_REDIRECT',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
            ...
            /*
                 * Billing address.
                 */
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Billing address',
                            'de'     => 'Rechnungsadresse',
                            'es'     => 'Dirección de facturación',
                            'fr'     => 'Adresse de facturation');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_FIRST_NAME_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'First name (enable)',
                            'de'     => 'Vorname (aktivieren)',
                            'es'     => 'El nombre de pila (permite)',
                            'fr'     => 'Le prénom (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_FIRST_NAME_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'First name (required)',
                            'de'     => 'Vorname (erforderlich)',
                            'es'     => 'Nombre de pila (requerido)',
                            'fr'     => 'Prénom (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_LAST_NAME_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Last name (enable)',
                            'de'     => 'Nachname (aktivieren)',
                            'es'     => 'El apellido (permite)',
                            'fr'     => 'Le nom (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_LAST_NAME_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Last name (required)',
                            'de'     => 'Nachname (erforderlich)',
                            'es'     => 'Apellido (requerido)',
                            'fr'     => 'Nom (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COMPANY_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Company (enable)',
                            'de'     => 'Unternehmen (aktivieren)',
                            'es'     => 'La empresa (permite)',
                            'fr'     => 'L<<single-quote>>entreprise (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COMPANY_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Company (required)',
                            'de'     => 'Unternehmen (erforderlich)',
                            'es'     => 'La empresa (requirió)',
                            'fr'     => 'L<<single-quote>>entreprise (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_EMAIL_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Email (enable)',
                            'de'     => 'E-Mail (aktivieren)',
                            'es'     => 'Email (permite)',
                            'fr'     => 'Email (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_EMAIL_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Email (required)',
                            'de'     => 'E-Mail (erforderlich)',
                            'es'     => 'Email (requerido)',
                            'fr'     => 'Email (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_PHONE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Phone number (enable)',
                            'de'     => 'Telefonnummer (aktivieren)',
                            'es'     => 'El número de teléfono (permite)',
                            'fr'     => 'Le numéro de téléphone (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_PHONE_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Phone number (required)',
                            'de'     => 'Telefonnummer (erforderlich)',
                            'es'     => 'Número de teléfono (requerido)',
                            'fr'     => 'Numéro de téléphone (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COUNTRY_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Country (enable)',
                            'de'     => 'Land (aktivieren)',
                            'es'     => 'El país (permite)',
                            'fr'     => 'Le pays (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COUNTRY_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Country (required)',
                            'de'     => 'Land (erforderlich)',
                            'es'     => 'País (requerido)',
                            'fr'     => 'Le pays (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_FIRST_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 1 (enable)',
                            'de'     => 'Adresszeile 1 (aktivieren)',
                            'es'     => 'Línea de dirección 1 (habilitar)',
                            'fr'     => 'Adresse ligne 1 (activer)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_FIRST_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 1 (required)',
                            'de'     => 'Adresszeile 1 (erforderlich)',
                            'es'     => 'Línea de dirección 1 (requerido)',
                            'fr'     => 'Adresse ligne 1 (obligatoire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_SECOND_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 2 (enable)',
                            'de'     => 'Adresszeile 2 (aktivieren)',
                            'es'     => 'Línea de dirección 2 (habilitar)',
                            'fr'     => 'Adresse ligne 2 (activer)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_SECOND_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 2 (required)',
                            'de'     => 'Adresszeile 2 (erforderlich)',
                            'es'     => 'Línea de dirección 2 (requerido)',
                            'fr'     => 'Adresse ligne 2 (obligatoire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_CITY_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'City (enable)',
                            'de'     => 'Stadt (aktivieren)',
                            'es'     => 'La ciudad (permite)',
                            'fr'     => 'La ville (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_CITY_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'City (required)',
                            'de'     => 'Stadt (erforderlich)',
                            'es'     => 'Ciudad (requerida)',
                            'fr'     => 'La ville (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_STATE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'State (enable)',
                            'de'     => 'Staat (aktivieren)',
                            'es'     => 'El estado (permite)',
                            'fr'     => 'L<<single-quote>>état (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_STATE_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'State (required)',
                            'de'     => 'Staat (erforderlich)',
                            'es'     => 'Estado (requerido)',
                            'fr'     => 'État (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ZIP_CODE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Zip code (enable)',
                            'de'     => 'Postleitzahl (aktivieren)',
                            'es'     => 'El código postal (permite)',
                            'fr'     => 'Le code postal (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ZIP_CODE_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
            ...
            /*
                 * Shipping address.
                 */
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Shipping address',
                            'de'     => 'Lieferadresse',
                            'es'     => 'Dirección de envío',
                            'fr'     => 'Adresse de livraison');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_FIRST_NAME_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'First name (enable)',
                            'de'     => 'Vorname (aktivieren)',
                            'es'     => 'El nombre de pila (permite)',
                            'fr'     => 'Le prénom (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_FIRST_NAME_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'First name (required)',
                            'de'     => 'Vorname (erforderlich)',
                            'es'     => 'Nombre de pila (requerido)',
                            'fr'     => 'Prénom (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_LAST_NAME_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Last name (enable)',
                            'de'     => 'Nachname (aktivieren)',
                            'es'     => 'El apellido (permite)',
                            'fr'     => 'Nom (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_LAST_NAME_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Last name (required)',
                            'de'     => 'Nachname (erforderlich)',
                            'es'     => 'Apellido (requerido)',
                            'fr'     => 'Nom (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COMPANY_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Company (enable)',
                            'de'     => 'Firma (aktivieren)',
                            'es'     => 'La empresa (permite)',
                            'fr'     => 'L<<single-quote>>entreprise (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COMPANY_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Company (required)',
                            'de'     => 'Firma (erforderlich)',
                            'es'     => 'La empresa (requirió)',
                            'fr'     => 'L<<single-quote>>entreprise (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_EMAIL_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Email (enable)',
                            'de'     => 'E-Mail (aktivieren)',
                            'es'     => 'El email (permite)',
                            'fr'     => 'Email (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_EMAIL_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Email (required)',
                            'de'     => 'E-Mail (erforderlich)',
                            'es'     => 'Email (requerido)',
                            'fr'     => 'Email (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_PHONE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Phone number (enable)',
                            'de'     => 'Telefonnummer (aktivieren)',
                            'es'     => 'El número de teléfono (permite)',
                            'fr'     => 'Le numéro de téléphone (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_PHONE_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Phone number (required)',
                            'de'     => 'Telefonnummer (erforderlich)',
                            'es'     => 'Número de teléfono (requerido)',
                            'fr'     => 'Numéro de téléphone (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COUNTRY_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Country (enable)',
                            'de'     => 'Land (aktivieren)',
                            'es'     => 'El país (permite)',
                            'fr'     => 'Le pays (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COUNTRY_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Country (required)',
                            'de'     => 'Land (erforderlich)',
                            'es'     => 'País (requerido)',
                            'fr'     => 'Pays (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_FIRST_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 1 (enable)',
                            'de'     => 'Adresszeile 1 (aktivieren)',
                            'es'     => 'Línea de dirección 1 (permite)',
                            'fr'     => 'Adresse ligne 1 (activer)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_FIRST_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 1 (required)',
                            'de'     => 'Adresszeile 1 (erforderlich)',
                            'es'     => 'Línea de dirección 1 (requerido)',
                            'fr'     => 'Adresse ligne 1 (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_SECOND_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 2 (enable)',
                            'de'     => 'Adresszeile 2 (aktivieren)',
                            'es'     => 'Línea de dirección 2 (habilitar)',
                            'fr'     => 'Adresse ligne 2 (activer)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_SECOND_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Address line 2 (required)',
                            'de'     => 'Adresszeile 2 (erforderlich)',
                            'es'     => 'Línea de dirección 2 (requerido)',
                            'fr'     => 'Adresse ligne 2 (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_CITY_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'City (enable)',
                            'de'     => 'Stadt (aktivieren)',
                            'es'     => 'La ciudad (permite)',
                            'fr'     => 'La ville (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_CITY_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'City (required)',
                            'de'     => 'Stadt (erforderlich)',
                            'es'     => '',
                            'fr'     => 'La ville (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_STATE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'State (enable)',
                            'de'     => 'Staat (aktivieren)',
                            'es'     => 'Ciudad (requerida)',
                            'fr'     => 'L<<single-quote>>état (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_STATE_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'State (required)',
                            'de'     => 'Staat (erforderlich)',
                            'es'     => 'Estado (requerido)',
                            'fr'     => 'L<<single-quote>>état (nécessaire)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ZIP_CODE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Zip code (enable)',
                            'de'     => 'Postleitzahl (aktivieren)',
                            'es'     => 'El código postal (permite)',
                            'fr'     => 'Le code postal (permet)');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ZIP_CODE_REQUIRED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS',
                            'text'   => 'Zip code (required)',
                            'de'     => 'Postleitzahl (erforderlich)',
                            'es'     => 'Código postal (requerido)',
        ...
        function settingsPaymentGatewaysHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
                            'parent' => '',
                            'text'   => 'Settings - Payment gateways - Help');

            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYMENT_ARRIVAL_ENABLED_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYMENT_ARRIVAL_WITH_APPROVAL_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYMENT_REDIRECT_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            /*
                 * Billing address.
                 */
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_FIRST_NAME_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_FIRST_NAME_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_LAST_NAME_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_LAST_NAME_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COMPANY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COMPANY_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_EMAIL_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_EMAIL_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_PHONE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_PHONE_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COUNTRY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_COUNTRY_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_FIRST_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_FIRST_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_SECOND_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ADDRESS_SECOND_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_CITY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_CITY_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_STATE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_STATE_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ZIP_CODE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_BILLING_ZIP_CODE_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            /*
                 * Shipping address.
                 */
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_FIRST_NAME_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_FIRST_NAME_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_LAST_NAME_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_LAST_NAME_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COMPANY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COMPANY_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_EMAIL_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_EMAIL_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_PHONE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_PHONE_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COUNTRY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_COUNTRY_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_FIRST_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_FIRST_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_SECOND_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ADDRESS_SECOND_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_CITY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_CITY_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_STATE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_STATE_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ZIP_CODE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_ADDRESS_SHIPPING_ZIP_CODE_REQUIRED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_HELP',
        ...
        function settingsSearch($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_SEARCH',
                            'parent' => '',
                            'text'   => 'Settings - Search');

            $text[] = array('key'    => 'SETTINGS_SEARCH_TITLE',
            ...
            /*
                 * General settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'General settings',
                            'de'     => 'Allgemeine Einstellungen',
                            'es'     => 'Configuración General',
                            'fr'     => 'Paramètres générales');
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_DATE_TYPE',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Date type',
                            'de'     => 'Datentyp',
                            'es'     => 'Tipo de fecha',
                            'fr'     => 'Type de date');
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_DATE_TYPE_AMERICAN',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'American (mm dd, yyyy)',
                            'de'     => 'Amerikanisch (MM.TT.JJJJ)',
                            'es'     => 'Americano (mm dd, aaaa)',
                            'fr'     => 'Américain (mm jj, aaaa)');
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_DATE_TYPE_EUROPEAN',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'European (dd mm yyyy)',
                            'de'     => 'Europa (TT MM JJJJ)',
                            'es'     => 'Europea (dd mm aa)',
                            'fr'     => 'Européen (jj mm aaaa)');
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_TEMPLATE',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Style template',
                            'de'     => 'Stilvorlage',
                            'es'     => 'Plantilla de estilo',
                            'fr'     => 'Modèle de style');
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_SEARCH_ENABLED',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_PRICE_ENABLED',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
            ...
            /*
                 * View Settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'View settings',
                            'de'     => 'Ansicht Einstellungen',
                            'es'     => 'Ajustes de vista',
                            'fr'     => 'Paramètres de vue');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_DEFAULT',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Default view',
                            'de'     => 'Standardansicht',
                            'es'     => 'Vista de falta',
                            'fr'     => 'Vue par défaut');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_DEFAULT_LIST',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'List',
                            'de'     => 'Liste',
                            'es'     => 'Lista',
                            'fr'     => 'Liste');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_DEFAULT_GRID',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Grid',
                            'de'     => 'Raster',
                            'es'     => 'Rejilla',
                            'fr'     => 'Grille');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_DEFAULT_MAP',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Map',
                            'de'     => 'Karte',
                            'es'     => 'Mapa',
                            'fr'     => 'Carte');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_LIST_VIEW_ENABLED',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'List view',
                            'de'     => 'Listenansicht',
                            'es'     => 'Vista de lista',
                            'fr'     => 'Vue de liste');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_GRID_VIEW_ENABLED',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Grid view',
                            'de'     => 'Rasteransicht',
                            'es'     => 'Vista de rejilla',
                            'fr'     => 'Vue de grille');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_MAP_VIEW_ENABLED',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Map view',
                            'de'     => 'Kartenansicht',
                            'es'     => 'Vista de mapa',
                            'fr'     => 'Vue de carte');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_RESULTS_PAGE',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Results per page',
                            'de'     => 'Ergebnisse pro Seite',
                            'es'     => 'Resultados por página',
                            'fr'     => 'Résultats par page');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_SIDEBAR_POSITION',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Sidebar position',
                            'de'     => 'Position der Seitenleiste',
                            'es'     => 'Sidebar posición',
                            'fr'     => 'Position de sidebar');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_SIDEBAR_POSITION_LEFT',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Left',
                            'de'     => 'Links',
                            'es'     => 'Izquierdo',
                            'fr'     => 'Gauche');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_SIDEBAR_POSITION_RIGHT',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Right',
                            'de'     => 'Rechte',
                            'es'     => 'Derecho',
                            'fr'     => 'Droit');
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_SIDEBAR_POSITION_TOP',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Top',
                            'de'     => 'Oben',
                            'es'     => 'Arriba',
            ...
            /*
                 * Currency settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Currency settings',
                            'de'     => 'Währungseinstellungen',
                            'es'     => 'Ajustes monetarios',
                            'fr'     => 'Paramètres de monnaie');
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Currency',
                            'de'     => 'Währung',
                            'es'     => 'Moneda',
                            'fr'     => 'Monnaie');
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_POSITION',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Currency position',
                            'de'     => 'Währungsposition',
                            'es'     => 'Posición monetaria',
                            'fr'     => 'Position de monnaie');
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_POSITION_BEFORE',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Before',
                            'de'     => 'Vorher',
                            'es'     => 'Antes',
                            'fr'     => 'Auparavant');
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_POSITION_BEFORE_WITH_SPACE',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Before with space',
                            'de'     => 'Vorher mit Leerzeich',
                            'es'     => 'Antes con espacio',
                            'fr'     => 'Auparavant avec espace');
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_POSITION_AFTER',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'After',
                            'de'     => 'Nachher',
                            'es'     => 'después',
                            'fr'     => 'Après');
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_POSITION_AFTER_WITH_SPACE',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'After with space',
            ...
            /*
                 * Days settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_DAYS_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Days settings',
                            'de'     => 'Einstellungen für Tage',
                            'es'     => 'Ajustes de días',
                            'fr'     => 'Paramètres de jours');
            $text[] = array('key'    => 'SETTINGS_SEARCH_DAYS_FIRST',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'First weekday',
                            'de'     => 'Erster Wochentag',
                            'es'     => 'Primer día laborable',
                            'fr'     => 'Premier jour ouvrable');
            $text[] = array('key'    => 'SETTINGS_SEARCH_DAYS_MULTIPLE_SELECT',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
            ...
            /*
                 * Hours settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_SETTINGS',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Hours settings',
                            'de'     => 'Stundeneinstellungen',
                            'es'     => 'Ajustes de horas',
                            'fr'     => 'Fixations d<<single-quote>>heures');
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_ENABLED',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Search hours',
                            'de'     => 'Suchzeiten',
                            'es'     => 'Horas de búsqueda',
                            'fr'     => 'Heures de recherche');
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_DEFINITIONS',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Define hours',
                            'de'     => 'Stunden definieren',
                            'es'     => 'Defina horas',
                            'fr'     => 'Définissez heures');
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_MULTIPLE_SELECT',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_AMPM',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
                            'text'   => 'Enable AM/PM format',
                            'de'     => 'Aktivieren Sie das AM/PM-Format',
                            'es'     => 'Habilitar formato AM/PM',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_AVAILABILITY_MIN',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_AVAILABILITY_MAX',
                            'parent' => 'PARENT_SETTINGS_SEARCH',
        ...
        function settingsSearchHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_SEARCH_HELP',
                            'parent' => '',
            ...
            /*
                 * General settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_DATE_TYPE_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_TEMPLATE_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
                            'text'   => 'Default value: default. Select styles template.',
                            'de'     => 'Standardwert: Standard. Wählen Sie eine Stilvorlage aus.',
                            'es'     => 'Valor predeterminado: predeterminado. Seleccione plantilla de estilos.',
                            'fr'     => 'Valeur par défaut : par défaut. Sélectionner le modèle de styles.');
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_SEARCH_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_GENERAL_PRICE_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            /*
                 * View Settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_DEFAULT_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_LIST_VIEW_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_GRID_VIEW_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_MAP_VIEW_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_RESULTS_PAGE_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_VIEW_SIDEBAR_POSITION_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            /*
                 * Currency settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_CURRENCY_POSITION_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
                            'text'   => 'Default value: Before. Select currency position.',
                            'de'     => 'Standardwert: Vorher. Währungsposition auswählen.',
                            'es'     => 'Valor predeterminado: Antes. Seleccione la posición de la moneda.',
            ...
            /*
                 * Days settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_DAYS_MULTIPLE_SELECT_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_DAYS_FIRST_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            /*
                 * Hours settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_DEFINITIONS_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_MULTIPLE_SELECT_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_HOURS_AMPM_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
                            'text'   => 'Default value: Disabled. Display hours in AM/PM format. NOTE: Hours definitions still need to be in 24 hours format.',
                            'de'     => 'Standardwert: Deaktiviert. Stunden im AM/PM-Format anzeigen. Hinweis: Die Stundendefinitionen müssen immer noch im 24-Stunden-Format vorliegen.',
                            'es'     => 'Valor predeterminado: Desactivado. Horas de visualización en formato AM/PM. NOTA: Las definiciones de horas todavía tienen que estar en formato de 24 horas.',
            ...
            /*
                 * Hours settings.
                 */
            $text[] = array('key'    => 'SETTINGS_SEARCH_AVAILABILITY_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_AVAILABILITY_MIN_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_SEARCH_AVAILABILITY_MAX_HELP',
                            'parent' => 'PARENT_SETTINGS_SEARCH_HELP',
        ...
        function settingsUsers($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_USERS',
                            'parent' => '',
                            'text'   => 'Settings - Users permissions');

            $text[] = array('key'    => 'SETTINGS_USERS_TITLE',
            ...
            /*
                 * Users permissions.
                 */
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_ADMINISTRATORS_LABEL',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_LABEL',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_CUSTOM_POSTS',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_CUSTOM_POSTS_LABEL',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            /*
                 ...
                 */
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_INDIVIDUAL',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            /*
                 * Search filters.
                 */
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ROLE',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Change role to',
                            'de'     => 'Ändern Sie die Rolle in',
                            'es'     => 'Papel de cambio',
                            'fr'     => 'Rôle de changement');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ROLE_ALL',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'All',
                            'de'     => 'Alle',
                            'es'     => 'Todo',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ORDER_BY',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Order by',
                            'de'     => 'Sortieren nach',
                            'es'     => 'Orden por',
                            'fr'     => 'Ordre par');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ORDER_BY_EMAIL',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Email',
                            'de'     => 'E-Mail',
                            'es'     => 'Email',
                            'fr'     => 'Email');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ORDER_BY_ID',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'ID',
                            'de'     => 'ID',
                            'es'     => 'id',
                            'fr'     => 'ID');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ORDER_BY_USERNAME',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Username',
                            'de'     => 'Benutzername',
                            'es'     => 'Nombre de Usuario',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ORDER',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Order',
                            'de'     => 'Reihenfolge',
                            'es'     => 'Orden',
                            'fr'     => 'Ordre');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ORDER_ASCENDING',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Ascending',
                            'de'     => 'Aufsteigender',
                            'es'     => 'Ascendente',
                            'fr'     => 'Ascendant');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_ORDER_DESCENDING',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Descending',
                            'de'     => 'Absteigender',
                            'es'     => 'Descendente',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_FILTERS_SEARCH',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Search',
                            'de'     => 'Suche',
                            'es'     => 'Búsqueda',
            ...
            /*
                 * Users list.
                 */
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_LIST_ID',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'ID',
                            'de'     => 'ID',
                            'es'     => 'ID',
                            'fr'     => 'ID');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_USERNAME',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Username',
                            'de'     => 'Benutzername',
                            'es'     => 'Nombre de Usuario',
                            'fr'     => 'Nom d<<single-quote>>utilisateur');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_EMAIL',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Email',
                            'de'     => 'E-Mail',
                            'es'     => 'Email',
                            'fr'     => 'Email');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_ROLE',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Role',
                            'de'     => 'Rolle',
                            'es'     => 'Papel',
                            'fr'     => 'Rôle');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_VIEW',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'View all calendars',
                            'de'     => 'Alle Kalender anzeigen',
                            'es'     => 'Vea todos los calendarios',
                            'fr'     => 'Voyez tous les calendriers');
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_USE',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_USE_CUSTOM_POSTS',
                            'parent' => 'PARENT_SETTINGS_USERS',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_USE_CALENDAR',
                            'parent' => 'PARENT_SETTINGS_USERS',
                            'text'   => 'Use calendar',
        ...
        function settingsUsersHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_USERS_HELP',
                            'parent' => '',
                            'text'   => 'Settings - Users Permissions - Help');

            $text[] = array('key'    => 'SETTINGS_USERS_PERMISSIONS_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_USERS_CUSTOM_POSTS_PERMISSIONS_HELP',
                            'parent' => 'PARENT_SETTINGS_USERS_HELP',
        ...
        function settingsLicences($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_LICENCES',
                            'parent' => '',
                            'text'   => 'Settings - Licences');

            $text[] = array('key'    => 'SETTINGS_LICENCES_TITLE',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Licences',
                            'de'     => 'Lizenzen',
                            'es'     => 'Licencias',
                            'fr'     => 'Licences');
            $text[] = array('key'    => 'SETTINGS_LICENCES_TITLE_PRO',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Status',
                            'de'     => 'Status',
                            'es'     => 'Estado',
                            'fr'     => 'Statut');
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_ACTIVATE',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Activate',
                            'de'     => 'Aktivieren',
                            'es'     => 'Activar',
                            'fr'     => 'Activez');
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_DEACTIVATE',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Deactivate',
                            'de'     => 'Deaktivieren',
                            'es'     => 'Desactivar',
                            'fr'     => 'Désactiver');
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_ACTIVATED',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Activated',
                            'de'     => 'Aktiviert',
                            'es'     => 'Activado',
                            'fr'     => 'Activé');
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_ACTIVATED_SUCCESS',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_ACTIVATED_ERROR',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_DEACTIVATED',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Deactivated',
                            'de'     => 'Deaktiviert',
                            'es'     => 'Desactivado',
                            'fr'     => 'Désactivé');
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_DEACTIVATED_SUCCESS',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_DEACTIVATED_ERROR',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_STATUS_TIMEOUT_ERROR',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_KEY',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Licence key',
                            'de'     => 'Lizenzschlüssel',
                            'es'     => 'Clave de licencia',
                            'fr'     => 'Clé de licence');
            $text[] = array('key'    => 'SETTINGS_LICENCES_EMAIL',
                            'parent' => 'PARENT_SETTINGS_LICENCES',
                            'text'   => 'Licence email',
                            'de'     => 'Lizenz-E-Mail',
        ...
        function settingsLicencesHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_LICENCES_HELP',
                            'parent' => '',
                            'text'   => 'Settings - Licences - Help');

            $text[] = array('key'    => 'SETTINGS_LICENCES_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_KEY_HELP',
                            'parent' => 'PARENT_SETTINGS_LICENCES_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_LICENCES_EMAIL_HELP',
                            'parent' => 'PARENT_SETTINGS_LICENCES_HELP',
