...
if (!class_exists('DOPBSPTranslationTextSmses')){
    class DOPBSPTranslationTextSmses{
         ...
         */
        function smses($text){
            $text[] = array('key'    => 'PARENT_SMSES',
                            'parent' => '',
                            'text'   => 'SMS templates');

            $text[] = array('key'    => 'SMSES_TITLE',
                            'parent' => 'PARENT_SMSES',
                            'text'   => 'SMS templates',
                            'de'     => 'SMS-Vorlagen',
                            'es'     => 'SMS plantillas',
                            'fr'     => 'Modèles de SMS');
            $text[] = array('key'    => 'SMSES_CREATED_BY',
                            'parent' => 'PARENT_SMSES',
                            'text'   => 'Created by',
                            'de'     => 'Erstellt von',
                            'es'     => 'Creado por',
                            'fr'     => 'Créé par');
            $text[] = array('key'    => 'SMSES_LOAD_SUCCESS',
                            'parent' => 'PARENT_SMSES',
        ...
        function smsesDefault($text){
            $text[] = array('key'    => 'PARENT_SMSES_DEFAULT',
                            'parent' => '',
                            'text'   => 'SMS templates - Default messages');

            $text[] = array('key'    => 'SMSES_DEFAULT_NAME',
             ...
             */
            $text[] = array('key'    => 'SMSES_DEFAULT_BOOK_ADMIN',
                            'parent' => 'PARENT_SMSES_DEFAULT',
            ...
            $text[] = array('key'    => 'SMSES_DEFAULT_BOOK_USER',
                            'parent' => 'PARENT_SMSES_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'SMSES_DEFAULT_BOOK_WITH_APPROVAL_ADMIN',
                            'parent' => 'PARENT_SMSES_DEFAULT',
                            'text'   => 'You received a booking request.',
                            'de'     => 'Sie haben eine Buchungsanfrage erhalten.',
                            'es'     => 'Recibió una solicitud de reserva.',
                            'fr'     => 'Vous avez reçu une demande de réservation.');
            $text[] = array('key'    => 'SMSES_DEFAULT_BOOK_WITH_APPROVAL_USER',
                            'parent' => 'PARENT_SMSES_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'SMSES_DEFAULT_APPROVED',
                            'parent' => 'PARENT_SMSES_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'SMSES_DEFAULT_CANCELED',
                            'parent' => 'PARENT_SMSES_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'SMSES_DEFAULT_REJECTED',
                            'parent' => 'PARENT_SMSES_DEFAULT',
        ...
        function smsesSms($text){
            $text[] = array('key'    => 'PARENT_SMSES_SMS',
                            'parent' => '',
                            'text'   => 'SMS templates - Templates');

            $text[] = array('key'    => 'SMSES_SMS_NAME',
                            'parent' => 'PARENT_SMSES_SMS',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'SMSES_SMS_LANGUAGE',
                            'parent' => 'PARENT_SMSES_SMS',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            'es'     => 'Lengua',
            ...
            $text[] = array('key'    => 'SMSES_SMS_TEMPLATE_SELECT_BOOK_WITH_APPROVAL_USER',
                            'parent' => 'PARENT_SMSES_SMS',
            ...
            $text[] = array('key'    => 'SMSES_SMS_LOADED',
                            'parent' => 'PARENT_SMSES_SMS',
        ...
        function smsesAddSms($text){
            ...
            $text[] = array('key'    => 'SMSES_ADD_SMS_SUCCESS',
                            'parent' => 'PARENT_SMSES_ADD_SMS',
        ...
        function smsesDeleteSms($text){
            $text[] = array('key'    => 'PARENT_SMSES_DELETE_SMS',
                            'parent' => '',
                            'text'   => 'SMS templates - Delete templates');

            $text[] = array('key'    => 'SMSES_DELETE_SMS_CONFIRMATION',
        ...
        function smsesHelp($text){
            $text[] = array('key'    => 'PARENT_SMSES_HELP',
                            'parent' => '',
                            'text'   => 'SMS templates - Help');

            $text[] = array('key'    => 'SMSES_HELP',
            ...
            $text[] = array('key'    => 'SMSES_ADD_SMS_HELP',
                            'parent' => 'PARENT_SMSES_HELP',
            ...
            $text[] = array('key'    => 'SMSES_SMS_NAME_HELP',
                            'parent' => 'PARENT_SMSES_HELP',
            ...
            $text[] = array('key'    => 'SMSES_SMS_LANGUAGE_HELP',
                            'parent' => 'PARENT_SMSES_HELP',
            ...
            $text[] = array('key'    => 'SMSES_SMS_TEMPLATE_SELECT_HELP',
                            'parent' => 'PARENT_SMSES_HELP',
