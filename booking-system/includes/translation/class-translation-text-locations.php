...
if (!class_exists('DOPBSPTranslationTextLocations')){
    class DOPBSPTranslationTextLocations{
        ...
        function locations($text){
            $text[] = array('key'    => 'PARENT_LOCATIONS',
                            'parent' => '',
                            'text'   => 'Locations');

            $text[] = array('key'    => 'LOCATIONS_TITLE',
                            'parent' => 'PARENT_LOCATIONS',
                            'text'   => 'Locations',
                            'de'     => 'Standorten',
                            'es'     => 'Ubicaciones',
                            'fr'     => 'Emplacements');
            $text[] = array('key'    => 'LOCATIONS_CREATED_BY',
                            'parent' => 'PARENT_LOCATIONS',
                            'text'   => 'Created by',
                            'de'     => 'Erstellt von',
                            'es'     => 'Creada por',
                            'fr'     => 'Créé par');
            $text[] = array('key'    => 'LOCATIONS_LOAD_SUCCESS',
                            'parent' => 'PARENT_LOCATIONS',
            ...
            $text[] = array('key'    => 'LOCATIONS_NO_LOCATIONS',
                            'parent' => 'PARENT_LOCATIONS',
        ...
        function locationsLocation($text){
            $text[] = array('key'    => 'PARENT_LOCATIONS_LOCATION',
                            'parent' => '',
                            'text'   => 'Locations - Location');

            $text[] = array('key'    => 'LOCATIONS_LOCATION_NAME',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_MAP',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Enter the address',
                            'de'     => 'Geben Sie die Adresse',
                            'es'     => 'Introducir la dirección',
                            'fr'     => 'Entrer l<<single-quote>>adresse');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_ADDRESS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Address',
                            'de'     => 'Adresse',
                            'es'     => 'Dirección',
                            'fr'     => 'Adresse');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_ALT_ADDRESS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Alternative address',
                            'de'     => 'Alternative Adresse',
                            'es'     => 'Dirección alternativa',
                            'fr'     => 'Autre adresse');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_CALENDARS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_NO_CALENDARS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_SHARE',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_LINK',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_IMAGE',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESSES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESSES_OTHER',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_LANGUAGES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_SHARE_SUBMIT_ERROR',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_SHARE_SUBMIT_ERROR_DUPLICATE',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_APARTMENT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Apartment',
                            'de'     => 'Wohnung',
                            'es'     => 'Apartamento',
                            'fr'     => 'Appartement');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_BABY_SITTER',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Babysitter',
                            'de'     => 'Babysitter',
                            'es'     => 'Niñera',
                            'fr'     => 'Baby-sitter');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_BAR',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Bar',
                            'de'     => 'Bar',
                            'es'     => 'Bar',
                            'fr'     => 'Bar');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_BASKETBALL_COURT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Basketball court(s)',
                            'de'     => 'Basketballplatz',
                            'es'     => 'Tribunal(es) de baloncesto',
                            'fr'     => 'Terrain(s) de basket-ball');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_BEAUTY_SALON',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Beauty salon',
                            'de'     => 'Schönheitssalon',
                            'es'     => 'Salón de belleza',
                            'fr'     => 'Salon de beauté');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_BIKES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Bikes',
                            'de'     => 'Fahrräder',
                            'es'     => 'Bicicletas',
                            'fr'     => 'Vélos');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_BOAT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Boat',
                            'de'     => 'Boot',
                            'es'     => 'Barco',
                            'fr'     => 'Bateau');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_BUSINESS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Business',
                            'de'     => 'Unternehmen',
                            'es'     => 'Negocio',
                            'fr'     => 'Entreprise');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_CAMPING',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Camping',
                            'de'     => 'Camping',
                            'es'     => 'Camping',
                            'fr'     => 'Camping');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_CAMPING_GEAR',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Camping gear',
                            'de'     => 'Campingausrüstung',
                            'es'     => 'Equipo de camping',
                            'fr'     => 'Matériel de camping');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_CARS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Cars',
                            'de'     => 'Wagen',
                            'es'     => 'Coches',
                            'fr'     => 'Voitures');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_CHEF',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Chef',
                            'de'     => 'Koch',
                            'es'     => 'Cocinero',
                            'fr'     => 'Chef');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_CINEMA',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Cinema',
                            'de'     => 'Kino',
                            'es'     => 'Cine',
                            'fr'     => 'Cinéma');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_CLOTHES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Clothes',
                            'de'     => 'Kleidung',
                            'es'     => 'Ropa',
                            'fr'     => 'Vêtement');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_COSTUMES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Costumes',
                            'de'     => 'Kostüme',
                            'es'     => 'Trajes',
                            'fr'     => 'Costumes');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_CLUB',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Club',
                            'de'     => 'Club',
                            'es'     => 'Club',
                            'fr'     => 'Club');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_DANCE_INSTRUCTOR',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Dance instructor',
                            'de'     => 'Tanzlehrer',
                            'es'     => 'Instructor de baile',
                            'fr'     => 'Professeur de danse');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_DENTIST',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Dentist',
                            'de'     => 'Zahnarzt',
                            'es'     => 'Dentista',
                            'fr'     => 'Dentiste');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_DESIGNER_HANDBAGS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Designer handbags',
                            'de'     => 'Designer-Handtaschen',
                            'es'     => 'Bolsos de diseño',
                            'fr'     => 'Sacs à main de concepteur');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_DOCTOR',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Doctor',
                            'de'     => 'Doktor',
                            'es'     => 'Doctor',
                            'fr'     => 'Docteur');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_ESTHETICIAN',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Esthetician',
                            'de'     => 'Kosmetikerin',
                            'es'     => 'Esteticista',
                            'fr'     => 'Esthéticienne');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_FOOTBALL_COURT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Football court(s)',
                            'de'     => 'Fußballplatz',
                            'es'     => 'Tribunal(es) de fútbol',
                            'fr'     => 'Terrain(s) de football');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_FISHING',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Fishing',
                            'de'     => 'Fischerei',
                            'es'     => 'Pesca',
                            'fr'     => 'Pêche');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_GADGETS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Gadgets',
                            'de'     => 'Gadgets',
                            'es'     => 'Gadgets',
                            'fr'     => 'Gadgets');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_GAMES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Games',
                            'de'     => 'Spiele',
                            'es'     => 'Juegos',
                            'fr'     => 'Jeux');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_GOLF',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Golf',
                            'de'     => 'Golf',
                            'es'     => 'Golf',
                            'fr'     => 'Golf');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_HAIRDRESSER',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Hairdresser',
                            'de'     => 'Friseur',
                            'es'     => 'Peluquería',
                            'fr'     => 'Coiffeur');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_HEALTH_CLUB',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Health club',
                            'de'     => 'Health Club',
                            'es'     => 'Gimnasio',
                            'fr'     => 'Centre de santé');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_HOSPITAL',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Hospital',
                            'de'     => 'Krankenhaus',
                            'es'     => 'hospital',
                            'fr'     => 'Hôpital');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_HOTEL',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Hotel',
                            'de'     => 'Hotel',
                            'es'     => 'Hotel',
                            'fr'     => 'Hôtel');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_HUNTING',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Hunting',
                            'de'     => 'Jagen',
                            'es'     => 'Caza',
                            'fr'     => 'Chasser');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_LAWYER',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Lawyer',
                            'de'     => 'Anwalt',
                            'es'     => 'Abogado',
                            'fr'     => 'Avocat');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_LIBRARY',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Library',
                            'de'     => 'Bibliothek',
                            'es'     => 'Biblioteca',
                            'fr'     => 'Bibliothèque');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_MASSAGE',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Massage',
                            'de'     => 'Massage',
                            'es'     => 'Masaje',
                            'fr'     => 'Massage');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_MUSIC_BAND',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Music band',
                            'de'     => 'Musikband',
                            'es'     => 'Banda de música',
                            'fr'     => 'Bande de musique');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_NAILS_SALON',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Nails salon',
                            'de'     => 'Nägel Salon',
                            'es'     => 'Salón de uñas',
                            'fr'     => 'Salon de manucure');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PARTY_SUPPLIES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Party supplies',
                            'de'     => 'Partyzubehör',
                            'es'     => 'Suministros para fiestas',
                            'fr'     => 'Provisions de parti');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PERSONAL_TRAINER',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Personal trainer',
                            'de'     => 'Personal Trainer',
                            'es'     => 'Entrenador personal',
                            'fr'     => 'Coach sportif');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PET_CARE',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Pet care',
                            'de'     => 'Tierpflege',
                            'es'     => 'Cuidado de mascotas',
                            'fr'     => 'Soins des animaux');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PHOTO_EQUIPMENT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Photo equipment',
                            'de'     => 'Fotoausrüstung',
                            'es'     => 'Equipo fotográfico',
                            'fr'     => 'Appareil photo');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PHOTOGRAPHER',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Photographer',
                            'de'     => 'Fotograf',
                            'es'     => 'Fotógrafo',
                            'fr'     => 'Photographe');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PILLATES_INSTRUCTOR',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Pilates instructor',
                            'de'     => 'Pilates-Lehrerin',
                            'es'     => 'Instructor de Pilates',
                            'fr'     => 'Instructeur de Pilates');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PLANE_TICKETS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Plane tickets',
                            'de'     => 'Flugtickets',
                            'es'     => 'Billetes de avión',
                            'fr'     => 'Billets d<<single-quote>>avion');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_PLANES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Plane(s)',
                            'de'     => 'Flugzeug',
                            'es'     => 'Avión(es)',
                            'fr'     => 'Avion(s)');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_RESTAURANT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Restaurant',
                            'de'     => 'Restaurant',
                            'es'     => 'Restaurante',
                            'fr'     => 'Restaurant');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_SHOES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Shoes',
                            'de'     => 'Schuhe',
                            'es'     => 'Zapatos',
                            'fr'     => 'Chaussures');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_SNOW_EQUIPMENT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Snow equipment',
                            'de'     => 'Schnee-Ausrüstung',
                            'es'     => 'Equipo de nieve',
                            'fr'     => 'Équipement de neige');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_SPA',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Spa',
                            'de'     => 'Spa',
                            'es'     => 'Spa',
                            'fr'     => 'Station thermale');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_SPORTS_COACH',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Sports coach',
                            'de'     => 'Sporttrainer',
                            'es'     => 'Entrenador deportivo',
                            'fr'     => 'Entraîneur sportif');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_TAXIES',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Taxies',
                            'de'     => 'Taxien',
                            'es'     => 'Taxis',
                            'fr'     => 'Taxis');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_TENIS_COURT',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Tennis court(s)',
                            'de'     => 'Tennisplätzen',
                            'es'     => 'Pista(s) de tenis',
                            'fr'     => 'Court(s) de tennis');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_THEATRE',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Theatre',
                            'de'     => 'Theater',
                            'es'     => 'Teatro',
                            'fr'     => 'Théâtre');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_VILLA',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Villa',
                            'de'     => 'Villa',
                            'es'     => 'Villa',
                            'fr'     => 'Villa');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_WEAPONS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Weapons',
                            'de'     => 'Waffen',
                            'es'     => 'Armas',
                            'fr'     => 'Armes');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESS_WORKING_TOOLS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Working tools',
                            'de'     => 'Arbeitswerkzeuge',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_LOADED',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
                            'text'   => 'Location loaded.',
                            'de'     => 'Standort geladen.',
                            'es'     => 'La ubicación cargó.',
                            'fr'     => 'L<<single-quote>>emplacement a chargé.');
            $text[] = array('key'    => 'LOCATIONS_LOCATION_NO_GOOGLE_MAPS',
                            'parent' => 'PARENT_LOCATIONS_LOCATION',
        ...
        function locationsAddLocation($text){
            $text[] = array('key'    => 'PARENT_LOCATIONS_ADD_LOCATION',
                            'parent' => '',
                            'text'   => 'Locations - Add location');

            $text[] = array('key'    => 'LOCATIONS_ADD_LOCATION_NAME',
                            'parent' => 'PARENT_LOCATIONS_ADD_LOCATION',
                            'text'   => 'New location',
                            'de'     => 'Neuen Standort',
                            'es'     => 'Nueva ubicación',
                            'fr'     => 'Nouvel emplacement');
            $text[] = array('key'    => 'LOCATIONS_ADD_LOCATION_SUBMIT',
                            'parent' => 'PARENT_LOCATIONS_ADD_LOCATION',
                            'text'   => 'Add location',
                            'de'     => 'Standort hinzufügen',
                            'es'     => 'Añada ubicación',
                            'fr'     => 'Ajoutez l<<single-quote>>emplacement');
            $text[] = array('key'    => 'LOCATIONS_ADD_LOCATION_ADDING',
                            'parent' => 'PARENT_LOCATIONS_ADD_LOCATION',
            ...
            $text[] = array('key'    => 'LOCATIONS_ADD_LOCATION_SUCCESS',
                            'parent' => 'PARENT_LOCATIONS_ADD_LOCATION',
        ...
        function locationsDeleteLocation($text){
            $text[] = array('key'    => 'PARENT_LOCATIONS_DELETE_LOCATION',
                            'parent' => '',
                            'text'   => 'Locations - Delete location');

            $text[] = array('key'    => 'LOCATIONS_DELETE_LOCATION_CONFIRMATION',
        ...
        function locationsHelp($text){
            $text[] = array('key'    => 'PARENT_LOCATIONS_HELP',
                            'parent' => '',
                            'text'   => 'Locations - Help');

            $text[] = array('key'    => 'LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_ADD_LOCATION_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
             ...
             * Location help.
             */
            $text[] = array('key'    => 'LOCATIONS_LOCATION_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_NAME_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_ADDRESS_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_ALT_ADDRESS_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_LINK_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_IMAGE_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESSES_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_BUSINESSES_OTHER_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_LANGUAGES_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
            ...
            $text[] = array('key'    => 'LOCATIONS_LOCATION_EMAIL_HELP',
                            'parent' => 'PARENT_LOCATIONS_HELP',
