...
if (!class_exists('DOPBSPTranslationTextCalendars')){
    class DOPBSPTranslationTextCalendars{
        ...
        function __construct(){
            ...
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'calendarsCalendarForm'));

            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'calendarsAddCalendar'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'calendarsEditCalendar'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'calendarsDeleteCalendar'));
        ...
        function calendarsCalendar($text){
            ...
            $text[] = array('key'      => 'CALENDARS_CALENDAR_ADD_MONTH_VIEW',
                            ...
                            'location' => 'calendar');
            $text[] = array('key'      => 'CALENDARS_CALENDAR_REMOVE_MONTH_VIEW',
                            'parent'   => 'PARENT_CALENDARS_CALENDAR',
                            ...
                            'location' => 'calendar');
            $text[] = array('key'      => 'CALENDARS_CALENDAR_PREVIOUS_MONTH',
                            'parent'   => 'PARENT_CALENDARS_CALENDAR',
                            'text'     => 'Previous month',
                            'de'       => 'Voriger monat',
                            'es'       => 'Mes anterior',
                            ...
                            'location' => 'calendar');
            $text[] = array('key'      => 'CALENDARS_CALENDAR_NEXT_MONTH',
                            'parent'   => 'PARENT_CALENDARS_CALENDAR',
                            'text'     => 'Next month',
                            'de'       => 'Nächster monat',
                            'es'       => 'Próximo mes',
                            ...
                            'pl'       => 'Następny miesiąc',
                            'location' => 'calendar');
            $text[] = array('key'      => 'CALENDARS_CALENDAR_AVAILABLE_ONE_TEXT',
                            'parent'   => 'PARENT_CALENDARS_CALENDAR',
                            'text'     => 'available',
                            'de'       => 'verfügbar',
                            'es'       => 'disponible',
                            ...
                            'pl'       => 'dostępne',
                            'location' => 'calendar');
            $text[] = array('key'      => 'CALENDARS_CALENDAR_AVAILABLE_TEXT',
                            'parent'   => 'PARENT_CALENDARS_CALENDAR',
                            'text'     => 'available',
                            'de'       => 'verfügbar',
                            'es'       => 'disponible',
                            ...
                            'pl'       => 'dostępne',
                            'location' => 'calendar');
            $text[] = array('key'      => 'CALENDARS_CALENDAR_BOOKED_TEXT',
                            'parent'   => 'PARENT_CALENDARS_CALENDAR',
                            'text'     => 'booked',
                            'de'       => 'belegt',
                            'es'       => 'reservado',
                            ...
                            'pl'       => 'zajęte',
                            'location' => 'calendar');
            $text[] = array('key'      => 'CALENDARS_CALENDAR_UNAVAILABLE_TEXT',
                            'parent'   => 'PARENT_CALENDARS_CALENDAR',
                            'text'     => 'unavailable',
                            'de'       => 'nicht verfügbar',
                            'es'       => 'no disponible',
        ...
        function calendarsCalendarForm($text){
            $text[] = array('key'    => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'parent' => '',
                            'text'   => 'Calendars - Calendar form',);

            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_DATE_START_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Start date',
                            'de'     => 'Startdatum',
                            'es'     => 'Fecha de inicio',
                            'fr'     => 'Date de début');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_DATE_END_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'End date',
                            'de'     => 'Enddatum',
                            'es'     => 'Fecha final',
                            'fr'     => 'Date de fin');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_HOURS_START_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Start hour',
                            'de'     => 'Startstunde',
                            'es'     => 'Hora de principio',
                            'fr'     => 'Heure de début');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_HOURS_END_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'End hour',
                            'de'     => 'Endstunde',
                            'es'     => 'Hora de final',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_SET_DAYS_AVAILABILITY_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_SET_HOURS_DEFINITIONS_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_SET_HOURS_AVAILABILITY_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_STATUS_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Status',
                            'de'     => 'Status',
                            'es'     => 'Estado',
                            'fr'     => 'Statut');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_STATUS_AVAILABLE_TEXT',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Available',
                            'de'     => 'Verfügbar',
                            'es'     => 'Disponible',
                            'fr'     => 'Disponible');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_STATUS_BOOKED_TEXT',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Booked',
                            'de'     => 'Gebucht',
                            'es'     => 'Reservado',
                            'fr'     => 'Réservé');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_STATUS_SPECIAL_TEXT',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Special',
                            'de'     => 'Besondere',
                            'es'     => 'Especial',
                            'fr'     => 'Spécial');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_STATUS_UNAVAILABLE_TEXT',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Unavailable',
                            'de'     => 'Nicht verfügbar',
                            'es'     => 'No disponible',
                            'fr'     => 'Indisponible');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_PRICE_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Price',
                            'de'     => 'Preis',
                            'es'     => 'Precio',
                            'fr'     => 'Prix');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_PROMO_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Promo price',
                            'de'     => 'Promo preis',
                            'es'     => 'Promo precio',
                            'fr'     => 'Prix promotionnel');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_AVAILABLE_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Number available',
                            'de'     => 'Verfügbare Anzahl',
                            'es'     => 'Número disponible',
                            'fr'     => 'Numéro disponible');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_HOURS_DEFINITIONS_CHANGE_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_HOURS_DEFINITIONS_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_HOURS_SET_DEFAULT_DATA_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_HOURS_INFO_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_HOURS_NOTES_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_GROUP_DAYS_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Group days',
                            'de'     => 'Gruppentage',
                            'es'     => 'Agrupe los días',
                            'fr'     => 'Groupez les jours');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_GROUP_HOURS_LABEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Group hours',
                            'de'     => 'Gruppenstunden',
                            'es'     => 'Agrupe las horas',
                            'fr'     => 'Groupez les heures');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_RESET_CONFIRMATION',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_SUBMIT',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Submit',
                            'de'     => 'Bestätigen',
                            'es'     => 'Someter',
                            'fr'     => 'Soumettre');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_RESET',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Reset',
                            'de'     => 'Zurücksetzen',
                            'es'     => 'Restablecer',
                            'fr'     => 'Réinitialiser');
            $text[] = array('key'    => 'CALENDARS_CALENDAR_FORM_CANCEL',
                            'parent' => 'PARENT_CALENDARS_CALENDAR_FORM',
                            'text'   => 'Cancel',
                            'de'     => 'Abbrechen',
                            'es'     => 'Cancelar',
        ...
        function calendarsAddCalendar($text){
            $text[] = array('key'    => 'PARENT_CALENDARS_ADD_CALENDAR',
                            'parent' => '',
                            'text'   => 'Calendars - Add calendar');

            $text[] = array('key'    => 'CALENDARS_ADD_CALENDAR_NAME',
                            'parent' => 'PARENT_CALENDARS_ADD_CALENDAR',
                            'text'   => 'New calendar',
                            'de'     => 'Neuen Kalender',
                            'es'     => 'Nuevo calendario',
                            'fr'     => 'Nouveau calendrier');
            $text[] = array('key'    => 'CALENDARS_ADD_CALENDAR_SUBMIT',
                            'parent' => 'PARENT_CALENDARS_ADD_CALENDAR',
                            'text'   => 'Add calendar',
                            'de'     => 'Kalender hinzufügen',
                            'es'     => 'Añada calendario',
                            'fr'     => 'Ajoutez le calendrier');
            $text[] = array('key'    => 'CALENDARS_DUPLICATE_CALENDAR_SUBMIT',
                            'parent' => 'PARENT_CALENDARS_ADD_CALENDAR',
                            'text'   => 'Duplicate calendar',
                            'de'     => 'Doppelter Kalender',
                            'es'     => 'Duplicar calendario',
                            'fr'     => 'Dupliquez du calendrier');
            $text[] = array('key'    => 'CALENDARS_ADD_CALENDAR_ADDING',
                            'parent' => 'PARENT_CALENDARS_ADD_CALENDAR',
            ...
            $text[] = array('key'    => 'CALENDARS_ADD_CALENDAR_SUCCESS',
                            'parent' => 'PARENT_CALENDARS_ADD_CALENDAR',
        ...
        function calendarsEditCalendar($text){
            $text[] = array('key'    => 'PARENT_CALENDARS_EDIT_CALENDAR',
                            'parent' => '',
                            'text'   => 'Calendars - Edit calendar');

            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_SETTINGS',
                            'parent' => 'PARENT_CALENDARS_EDIT_CALENDAR',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_NOTIFICATIONS',
                            'parent' => 'PARENT_CALENDARS_EDIT_CALENDAR',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_PAYMENT_GATEWAYS',
                            'parent' => 'PARENT_CALENDARS_EDIT_CALENDAR',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_USERS_PERMISSIONS',
                            'parent' => 'PARENT_CALENDARS_EDIT_CALENDAR',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_NEW_RESERVATIONS',
                            'parent' => 'PARENT_CALENDARS_EDIT_CALENDAR',
                            'text'   => 'new reservations',
                            'de'     => 'neue reservierungen',
                            'es'     => 'nuevas reservas',
                            'fr'     => 'Nouvelles réservations');
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_DELETE',
                            'parent' => 'PARENT_CALENDARS_EDIT_CALENDAR',
        ...
        function calendarsDeleteCalendar($text){
            $text[] = array('key'    => 'PARENT_CALENDARS_DELETE_CALENDAR',
                            'parent' => '',
                            'text'   => 'Calendars - Delete calendar');

            $text[] = array('key'    => 'CALENDARS_DELETE_CALENDAR_CONFIRMATION',
        ...
        function calendarsHelp($text){
            $text[] = array('key'    => 'PARENT_CALENDARS_HELP',
                            'parent' => '',
                            'text'   => 'Calendars - Help');

            $text[] = array('key'    => 'CALENDARS_HELP',
            ...
            $text[] = array('key'    => 'CALENDARS_ADD_CALENDAR_HELP',
                            'parent' => 'PARENT_CALENDARS_HELP',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_HELP',
                            'parent' => 'PARENT_CALENDARS_HELP',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_SETTINGS_HELP',
                            'parent' => 'PARENT_CALENDARS_HELP',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_EMAILS_HELP',
                            'parent' => 'PARENT_CALENDARS_HELP',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_PAYMENT_GATEWAYS_HELP',
                            'parent' => 'PARENT_CALENDARS_HELP',
            ...
            $text[] = array('key'    => 'CALENDARS_EDIT_CALENDAR_USERS_HELP',
                            'parent' => 'PARENT_CALENDARS_HELP',
            ...
            $text[] = array('key'    => 'CALENDARS_CALENDAR_NOTIFICATIONS_HELP',
                            'parent' => 'PARENT_CALENDARS_HELP',
