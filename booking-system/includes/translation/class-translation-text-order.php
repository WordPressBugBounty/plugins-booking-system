...
if (!class_exists('DOPBSPTranslationTextOrder')){
    class DOPBSPTranslationTextOrder{
         ...
         */
        function order($text){
            $text[] = array('key'      => 'PARENT_ORDER',
                            'parent'   => '',
                            'text'     => 'Order',
                            'location' => 'all');

            $text[] = array('key'      => 'ORDER_TITLE',
                            'parent'   => 'PARENT_ORDER',
                            'text'     => 'Order',
                            'de'       => 'Bestellung',
                            'es'       => 'Orden',
                            'fr'       => 'Ordre',
                            'location' => 'all',);
            $text[] = array('key'      => 'ORDER_UNAVAILABLE',
                            'parent'   => 'PARENT_ORDER',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_UNAVAILABLE_COUPON',
                            'parent'   => 'PARENT_ORDER',
             ...
             * Payment methods.
             */
            $text[] = array('key'      => 'ORDER_PAYMENT_METHOD',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_FULL_AMOUNT',
                            'parent'   => 'PARENT_RESERVATIONS_RESERVATION',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_METHOD_NONE',
                            'parent'   => 'PARENT_RESERVATIONS_RESERVATION',
                            'text'     => 'None',
                            'de'       => 'Keine',
                            'es'       => 'Ninguno',
                            'fr'       => 'Aucun',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_METHOD_ARRIVAL',
                            'parent'   => 'PARENT_RESERVATIONS_RESERVATION',
                            'text'     => 'On arrival',
                            'de'       => 'Bei der Ankunft',
                            'es'       => 'A la llegada',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_METHOD_WOOCOMMERCE',
                            'parent'   => 'PARENT_RESERVATIONS_RESERVATION',
                            'text'     => 'WooCommerce',
                            'de'       => 'WooCommerce',
                            'es'       => 'WooCommerce',
                            'fr'       => 'WooCommerce',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_METHOD_WOOCOMMERCE_ORDER_ID',
                            'parent'   => 'PARENT_RESERVATIONS_RESERVATION',
                            'text'     => 'Order ID',
                            'de'       => 'Bestell-ID',
                            'es'       => 'Orden ID',
                            'fr'       => 'Ordre ID',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_METHOD_TRANSACTION_ID',
                            'parent'   => 'PARENT_RESERVATIONS_RESERVATION',
                            'text'     => 'Transaction ID',
                            'de'       => 'Transaktions ID',
             ...
             * Front end.
             */
            $text[] = array('key'      => 'ORDER_PAYMENT_ARRIVAL',
                            'parent'   => 'PARENT_ORDER',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_ARRIVAL_WITH_APPROVAL',
                            'parent'   => 'PARENT_ORDER',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_ARRIVAL_SUCCESS',
                            'parent'   => 'PARENT_ORDER',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_ARRIVAL_WITH_APPROVAL_SUCCESS',
                            'parent'   => 'PARENT_ORDER',
            ...
            $text[] = array('key'      => 'ORDER_TERMS_AND_CONDITIONS',
                            'parent'   => 'PARENT_ORDER',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_TERMS_AND_CONDITIONS_INVALID',
                            'parent'   => 'PARENT_ORDER',
            ...
            $text[] = array('key'      => 'ORDER_PRIVACY',
                            'parent'   => 'PARENT_ORDER',
                            'text'     => 'I agree to the Privacy Policy.',
                            'de'       => 'Ich stimme den Datenschutzbestimmungen zu.',
                            'es'       => 'Acepto la política de privacidad.',
                            'fr'       => 'J<<single-quote>>accepte la politique de confidentialité.',
                            'nl'       => 'Ik ga akkoord met het privacybeleid.',
                            'pl'       => 'Zgadzam się z Polityką Prywatności.',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PRIVACY_INVALID',
                            'parent'   => 'PARENT_ORDER',
                            'text'     => 'You must agree with our Privacy Policy to continue.',
                            'de'       => 'Um fortzufahren, müssen Sie unserer Datenschutzrichtlinie zustimmen.',
                            'es'       => 'Debe aceptar nuestra política de privacidad para continuar.',
                            'fr'       => 'Vous devez accepter notre politique de confidentialité pour continuer.',
                            'nl'       => 'U moet akkoord gaan met ons Privacybeleid om verder te gaan.',
                            'pl'       => 'Aby kontynuować, musisz zgodzić się z naszą Polityką Prywatności.',
                            'location' => 'all');

            $text[] = array('key'      => 'ORDER_BOOK',
                            'parent'   => 'PARENT_ORDER',
                            'text'     => 'Book now',
                            'de'       => 'Jetzt buchen',
                            'es'       => 'Reservar ahora',
        ...
        function orderAddress($text){
            $text[] = array('key'      => 'PARENT_ORDER_ADDRESS',
                            'parent'   => '',
                            'text'     => 'Order - Billing/shipping address',
                            'location' => 'all');

            $text[] = array('key'      => 'ORDER_ADDRESS_SELECT_PAYMENT_METHOD',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_BILLING',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_BILLING_DISABLED',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_SHIPPING',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_SHIPPING_DISABLED',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_SHIPPING_COPY',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
            ...
            $text[] = array('key'      => 'ORDER_ADDRESS_FIRST_NAME',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'First name',
                            'de'       => 'Vorname',
                            'es'       => 'Nombre',
                            'fr'       => 'Prénom',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_LAST_NAME',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Last name',
                            'de'       => 'Nachname',
                            'es'       => 'Apellido',
                            'fr'       => 'Nom',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_COMPANY',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Company',
                            'de'       => 'Firma',
                            'es'       => 'Compañía',
                            'fr'       => 'Entreprise',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_EMAIL',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Email',
                            'de'       => 'E-Mail',
                            ...
                            'fr'       => 'Email',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_PHONE',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Phone number',
                            'de'       => 'Telefonnummer',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_COUNTRY',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Country',
                            'de'       => 'Land',
                            'es'       => 'País',
                            'fr'       => 'Pays',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_ADDRESS_FIRST',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Address line 1',
                            'de'       => 'Adresszeile 1',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_ADDRESS_SECOND',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Address line 2',
                            'de'       => 'Adresszeile 2',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_CITY',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'City',
                            'de'       => 'Stadt',
                            'es'       => 'Ciudad',
                            'fr'       => 'Ville',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_STATE',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'State/Province',
                            'de'       => 'Staat/Provinz',
                            'es'       => 'Estado/Provincia',
                            'fr'       => 'État/Province',
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_ADDRESS_ZIP_CODE',
                            'parent'   => 'PARENT_ORDER_ADDRESS',
                            'text'     => 'Zip code',
                            'de'       => 'Postleitzahl',
                            'es'       => 'Código postal',
