...
if (!class_exists('DOPBSPTranslationTextCart')){
    class DOPBSPTranslationTextCart{
         ...
         */
        function cart($text){
            $text[] = array('key'    => 'PARENT_CART',
                            'parent' => '',
                            'text'   => 'Cart');

            $text[] = array('key'      => 'CART_TITLE',
                            'parent'   => 'PARENT_CART',
                            'text'     => 'Cart',
                            'de'       => 'Warenkorb',
                            'es'       => 'Carrito',
            ...
            $text[] = array('key'      => 'CART_ERROR',
                            ...
                            'fr'       => 'Erreur',
                            'location' => 'all');
            $text[] = array('key'      => 'CART_UNAVAILABLE',
                            'parent'   => 'PARENT_CART',
