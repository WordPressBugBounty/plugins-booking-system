...
if (!class_exists('DOPBSPTranslationTextDiscounts')){
    class DOPBSPTranslationTextDiscounts{
        ...
        function __construct(){
            ...
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsAddDiscount'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDeleteDiscount'));

            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountItems'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountItem'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountAddItem'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountDeleteItem'));

            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountItemRules'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountItemRule'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountItemAddRule'));
            add_filter('dopbsp_filter_translation_text',
                       array(&$this,
                             'discountsDiscountItemDeleteRule'));
        ...
        function discounts($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS',
                            'parent' => '',
                            'text'   => 'Discounts');

            $text[] = array('key'    => 'DISCOUNTS_TITLE',
                            'parent' => 'PARENT_DISCOUNTS',
                            'text'   => 'Discounts',
                            'de'     => 'Rabatte',
                            'es'     => 'Descuentos',
                            'fr'     => 'Remises');
            $text[] = array('key'    => 'DISCOUNTS_CREATED_BY',
                            'parent' => 'PARENT_DISCOUNTS',
                            'text'   => 'Created by',
                            'de'     => 'Erstellt von',
                            'es'     => 'Creada por',
                            'fr'     => 'Créé par');
            $text[] = array('key'    => 'DISCOUNTS_LOAD_SUCCESS',
                            'parent' => 'PARENT_DISCOUNTS',
                            'text'   => 'Discounts list loaded.',
                            'de'     => 'Rabattliste geladen.',
                            'es'     => 'La lista de descuentos cargó.',
                            'fr'     => 'Liste de remises chargée.');
            $text[] = array('key'    => 'DISCOUNTS_NO_DISCOUNTS',
                            'parent' => 'PARENT_DISCOUNTS',
        ...
        function discountsDiscount($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT',
                            'parent' => '',
                            'text'   => 'Discounts - Discount');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_NAME',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_LANGUAGE',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            'es'     => 'Idioma',
                            'fr'     => 'Langue');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_EXTRAS',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_LOADED',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT',
        ...
        function discountsAddDiscount($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_ADD_DISCOUNT',
                            'parent' => '',
                            'text'   => 'Discounts - Add discount');

            $text[] = array('key'    => 'DISCOUNTS_ADD_DISCOUNT_NAME',
                            'parent' => 'PARENT_DISCOUNTS_ADD_DISCOUNT',
                            'text'   => 'New discount',
                            'de'     => 'Neuer Rabatt',
                            'es'     => 'Nuevo descuento',
                            'fr'     => 'Nouveau remise');
            $text[] = array('key'    => 'DISCOUNTS_ADD_DISCOUNT_SUBMIT',
                            'parent' => 'PARENT_DISCOUNTS_ADD_DISCOUNT',
                            'text'   => 'Add discount',
                            'de'     => 'Rabatt hinzufügen',
                            'es'     => 'Añada descuento',
                            'fr'     => 'Ajoutez la remise');
            $text[] = array('key'    => 'DISCOUNTS_ADD_DISCOUNT_ADDING',
                            'parent' => 'PARENT_DISCOUNTS_ADD_DISCOUNT',
                            'text'   => 'Adding a new discount ...',
                            'de'     => 'Hinzufügen eines neuen Rabatts ...',
                            'es'     => 'Añadir un nuevo descuento ...',
                            'fr'     => 'Ajouter un nouveau rabais ...');
            $text[] = array('key'    => 'DISCOUNTS_ADD_DISCOUNT_SUCCESS',
                            'parent' => 'PARENT_DISCOUNTS_ADD_DISCOUNT',
        ...
        function discountsDeleteDiscount($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DELETE_DISCOUNT',
                            'parent' => '',
                            'text'   => 'Discounts - Delete discount');

            $text[] = array('key'    => 'DISCOUNTS_DELETE_DISCOUNT_CONFIRMATION',
        ...
        function discountsDiscountItems($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_ITEMS',
                            'parent' => '',
                            'text'   => 'Discounts - Discount items');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEMS',
        ...
        function discountsDiscountItem($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'parent' => '',
                            'text'   => 'Discounts - Discount item');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_SHOW_SETTINGS',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Show settings',
                            'de'     => 'Einstellungen anzeigen',
                            'es'     => 'Muestre los ajustes',
                            'fr'     => 'Montrer les paramètres');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_HIDE_SETTINGS',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Hide settings',
                            'de'     => 'Einstellungen ausblenden',
                            'es'     => 'Oculte los ajustes',
                            'fr'     => 'Cachez des paramètres');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_SORT',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Sort',
                            'de'     => 'Sortieren',
                            'es'     => 'Ordenar',
             ...
             * Settings labels.
             */
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_LABEL_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Label',
                            'de'     => 'Etikett',
                            'es'     => 'Etiqueta',
                            'fr'     => 'Étiquette');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_START_TIME_LAPSE_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_END_TIME_LAPSE_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_OPERATION_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Operation',
                            'de'     => 'Vorgang',
                            'es'     => 'Operación',
                            'fr'     => 'Opération');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_PRICE_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Price/Percent',
                            'de'     => 'Preis/Prozent',
                            'es'     => 'Precio/Por ciento',
                            'fr'     => 'Prix/pour cent');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_PRICE_TYPE_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Price type',
                            'de'     => 'Preistyp',
                            'es'     => 'Tipo de precios',
                            'fr'     => 'Type des prix');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_PRICE_BY_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM',
                            'text'   => 'Price by',
                            'de'     => 'Preis von',
                            'es'     => 'Precio por',
        ...
        function discountsDiscountAddItem($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_ADD_ITEM',
                            'parent' => '',
                            'text'   => 'Discounts - Add discount item');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ADD_ITEM_SUBMIT',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ADD_ITEM',
                            'text'   => 'Add item',
                            'de'     => 'Element hinzufügen',
                            'es'     => 'Añada artículo',
                            'fr'     => 'Ajoutez article');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ADD_ITEM_LABEL',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ADD_ITEM',
                            'text'   => 'New item',
                            'de'     => 'Neues Element',
                            'es'     => 'Nuevo artículo',
                            'fr'     => 'Nouvel article');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ADD_ITEM_ADDING',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ADD_ITEM',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ADD_ITEM_SUCCESS',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ADD_ITEM',
        ...
        function discountsDiscountDeleteItem($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_DELETE_ITEM',
                            'parent' => '',
                            'text'   => 'Discounts - Delete discount item');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_DELETE_ITEM_CONFIRMATION',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_DELETE_ITEM_SUBMIT',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_DELETE_ITEM',
                            'text'   => 'Delete',
                            'de'     => 'Löschen',
                            'es'     => 'Borrar',
                            'fr'     => 'Supprimer');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_DELETE_ITEM_DELETING',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_DELETE_ITEM',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_DELETE_ITEM_SUCCESS',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_DELETE_ITEM',
        ...
        function discountsDiscountItemRules($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULES',
                            'parent' => '',
                            'text'   => 'Discounts - Discount item - Rules');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_LABEL',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_LABELS_OPERATION',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULES',
                            'text'   => 'Operation',
                            'de'     => 'Vorgang',
                            'es'     => 'Operación',
                            'fr'     => 'Opération');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_LABELS_PRICE',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULES',
                            'text'   => 'Price/Percent',
                            'de'     => 'Preis/Prozent',
                            'es'     => 'Precio/Por ciento',
                            'fr'     => 'Prix/pour cent');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_LABELS_PRICE_TYPE',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULES',
                            'text'   => 'Price type',
                            'de'     => 'Preistyp',
                            'es'     => 'Tipo de precios',
                            'fr'     => 'Type des prix');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_LABELS_PRICE_BY',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULES',
                            'text'   => 'Price by',
                            'de'     => 'Preis von',
                            'es'     => 'Precio por',
        ...
        function discountsDiscountItemRule($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULE',
                            'parent' => '',
                            'text'   => 'Discounts - Discount item - Rule');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_PRICE_TYPE_FIXED',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULE',
                            'text'   => 'Fixed',
                            'de'     => 'Fest',
                            'es'     => 'Fijo',
                            'fr'     => 'Fixe');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_PRICE_TYPE_PERCENT',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULE',
                            'text'   => 'Percent',
                            'de'     => 'Prozent',
                            'es'     => 'Por ciento',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_PRICE_BY_ONCE',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULE',
                            'text'   => 'Once',
                            'de'     => 'Einmal',
                            'es'     => 'Una vez',
                            'fr'     => 'Une fois');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_PRICE_BY_PERIOD',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULE',
                            'text'   => 'day/hour',
                            'de'     => 'tag/stunde',
                            'es'     => 'día/hora',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULE_SORT',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_RULE',
                            'text'   => 'Sort',
                            'de'     => 'Sortieren',
                            'es'     => 'Ordenar',
        ...
        function discountsDiscountItemAddRule($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_ADD_RULE',
                            'parent' => '',
                            'text'   => 'Discounts - Discount item - Add rule');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_ADD_RULE_SUBMIT',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_ADD_RULE',
                            'text'   => 'Add rule',
                            'de'     => 'Regel hinzufügen',
                            'es'     => 'Añada regla',
                            'fr'     => 'Ajoutez règle');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_ADD_RULE_ADDING',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_ADD_RULE',
                            'text'   => 'Adding a new rule ...',
                            'de'     => 'Hinzufügen einer neuen Regel ...',
                            'es'     => 'Añadir una nueva regla ...',
                            'fr'     => 'Ajout d<<single-quote>>une nouvelle règle...');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_ADD_RULE_SUCCESS',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_ADD_RULE',
        ...
        function discountsDiscountItemDeleteRule($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE',
                            'parent' => '',
                            'text'   => 'Discounts - Discount item - Delete rule');

            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE_CONFIRMATION',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE_SUBMIT',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE',
                            'text'   => 'Delete',
                            'de'     => 'Löschen',
                            'es'     => 'Borrar',
                            'fr'     => 'Supprimer');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE_DELETING',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE',
                            'text'   => 'Deleting  rule ...',
                            'de'     => 'Regel wird gelöscht...',
                            'es'     => 'Supresión de regla...',
                            'fr'     => 'Suppression de règle');
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE_SUCCESS',
                            'parent' => 'PARENT_DISCOUNTS_DISCOUNT_ITEM_DELETE_RULE',
        ...
        function discountsHelp($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_HELP',
                            'parent' => '',
                            'text'   => 'Discounts - Help');

            $text[] = array('key'    => 'DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_ADD_DISCOUNT_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
             ...
             * Discount help.
             */
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_NAME_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_LANGUAGE_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_EXTRAS_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ADD_ITEM_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_EDIT_ITEM_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_DELETE_ITEM_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_SORT_ITEM_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
             ...
             * Discount item help.
             */
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_LABEL_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_START_TIME_LAPSE_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_END_TIME_LAPSE_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_OPERATION_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_PRICE_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_PRICE_TYPE_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_PRICE_BY_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
            ...
            $text[] = array('key'    => 'DISCOUNTS_DISCOUNT_ITEM_RULES_HELP',
                            'parent' => 'PARENT_DISCOUNTS_HELP',
        ...
        function discountsFrontEnd($text){
            $text[] = array('key'    => 'PARENT_DISCOUNTS_FRONT_END',
                            'parent' => '',
                            'text'   => 'Discounts - Front end');

            $text[] = array('key'      => 'DISCOUNTS_FRONT_END_TITLE',
                            ...
                            'fr'       => 'Remise',
                            'location' => 'all');
            $text[] = array('key'      => 'DISCOUNTS_FRONT_END_BY_DAY',
                            'parent'   => 'PARENT_DISCOUNTS_FRONT_END',
                            'text'     => 'day',
                            'de'       => 'tag',
                            'es'       => 'día',
                            'fr'       => 'jour',
                            'location' => 'all');
            $text[] = array('key'      => 'DISCOUNTS_FRONT_END_BY_HOUR',
                            'parent'   => 'PARENT_DISCOUNTS_FRONT_END',
                            'text'     => 'hour',
                            'de'       => 'stunde',
                            'es'       => 'hora',
