...
if (!class_exists('DOPBSPTranslationTextDashboard')){
    class DOPBSPTranslationTextDashboard{
        ...
        function dashboard($text){
            $text[] = array('key'    => 'PARENT_DASHBOARD',
                            'parent' => '',
                            'text'   => 'Dashboard');

            $text[] = array('key'    => 'DASHBOARD_TITLE',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Dashboard',
                            'de'     => 'Dashboard',
                            'es'     => 'Panel de control',
                            'fr'     => 'Tableau de bord');
            $text[] = array('key'    => 'DASHBOARD_SUBTITLE',
                            'parent' => 'PARENT_DASHBOARD',
             ...
             * Get started
             */
            $text[] = array('key'    => 'DASHBOARD_GET_STARTED',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Get started',
                            'de'     => 'Anfangen',
                            'es'     => 'Empezar',
                            'fr'     => 'Commencer');
            $text[] = array('key'    => 'DASHBOARD_GET_STARTED_CALENDARS',
                            'parent' => 'PARENT_DASHBOARD',
             ...
             * More actions
             */
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'More actions',
                            'de'     => 'Weitere Aktionen',
                            'es'     => 'Más acciones',
                            'fr'     => 'Actions supplémentaires');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_COUPONS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add coupons',
                            'de'     => 'Coupons hinzufügen',
                            'es'     => 'Más acciones',
                            'fr'     => 'Ajoutez coupons');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_DISCOUNTS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add discounts',
                            'de'     => 'Rabatte hinzufügen',
                            'es'     => 'Añada descuentos',
                            'fr'     => 'Ajoutez des remises');//
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_EMAILS',
                            'parent' => 'PARENT_DASHBOARD',
            ...
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_EXTRAS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add extras',
                            'de'     => 'Extras hinzufügen',
                            'es'     => 'Añada extras',
                            'fr'     => 'Add suppléments');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_FEES',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add taxes & fees',
                            'de'     => 'Steuern und Gebühren hinzufügen',
                            'es'     => 'Añadir impuestos y tasas',
                            'fr'     => 'Ajouter taxes et frais');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_FORMS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add forms',
                            'de'     => 'Formulare hinzufügen',
                            'es'     => 'Añada formulario',
                            'fr'     => 'Ajoutez formulaires');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_RULES',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add rules',
                            'de'     => 'Regeln hinzufügen',
                            'es'     => 'Añadir reglas',
                            'fr'     => 'Ajoutez des règles');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_SEARCH',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add search',
                            'de'     => 'Suche hinzufügen',
                            'es'     => 'Añada búsqueda',
                            'fr'     => 'Ajoutez la recherche');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_SETTINGS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Change settings',
                            'de'     => 'Einstellungen ändern',
                            'es'     => 'Cambiar los ajustes',
                            'fr'     => 'Modifier les paramètres');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_TEMPLATES',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Add templates',
                            'de'     => 'Fügen Sie Vorlagen hinzu',
                            'es'     => 'Añada plantillas',
                            'fr'     => 'Ajoutez des modèles');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_TOOLS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Tools',
                            'de'     => 'Werkzeuge',
                            'es'     => 'Herramientas',
                            'fr'     => 'Outils');
            $text[] = array('key'    => 'DASHBOARD_MORE_ACTIONS_TRANSLATION',
                            'parent' => 'PARENT_DASHBOARD',
             ...
             * API
             */
            $text[] = array('key'    => 'DASHBOARD_API_TITLE',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'API key',
                            'de'     => 'API-Schlüssel',
                            'es'     => 'Clave de API',
                            'fr'     => 'Clé d<<single-quote>>API');
            $text[] = array('key'    => 'DASHBOARD_API_RESET',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Reset API key',
                            'de'     => 'API-Schlüssel zurücksetzen',
                            'es'     => 'Reiniciar Clave de API',
                            'fr'     => 'Réinitialiser la clé API');
            $text[] = array('key'    => 'DASHBOARD_API_RESET_SUCCESS',
                            'parent' => 'PARENT_DASHBOARD',
            ...
            $text[] = array('key'    => 'DASHBOARD_API_HELP',
                            'parent' => 'PARENT_DASHBOARD',
             ...
             * Server
             */
            $text[] = array('key'    => 'DASHBOARD_SERVER_TITLE',
                            'parent' => 'PARENT_DASHBOARD',
            ...
            $text[] = array('key'    => 'DASHBOARD_SERVER_REQUIRED',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Required',
                            'de'     => 'Erforderlich',
                            'es'     => 'Necesario',
                            'fr'     => 'Nécessaire');
            $text[] = array('key'    => 'DASHBOARD_SERVER_AVAILABLE',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Available',
                            'de'     => 'Verfügbar',
                            'es'     => 'Disponible',
                            'fr'     => 'Disponible');
            $text[] = array('key'    => 'DASHBOARD_SERVER_STATUS',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Status',
                            'de'     => 'Status',
                            'es'     => 'Estado',
            ...
            $text[] = array('key'    => 'DASHBOARD_SERVER_NO',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'No',
                            'de'     => 'Nein',
                            'es'     => 'No',
                            'fr'     => 'Non');
            $text[] = array('key'    => 'DASHBOARD_SERVER_YES',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Yes',
                            'de'     => 'Ja',
                            'es'     => 'Sí',
            ...
            $text[] = array('key'    => 'DASHBOARD_SERVER_VERSION',
                            'parent' => 'PARENT_DASHBOARD',
            ...
            $text[] = array('key'    => 'DASHBOARD_SERVER_PHP_VERSION',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'PHP version',
                            'de'     => 'Version des PHP',
                            'es'     => 'Versión de PHP',
                            'fr'     => 'Version de PHP');
            $text[] = array('key'    => 'DASHBOARD_SERVER_MYSQL_VERSION',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'MySQL version',
                            'de'     => 'Version des MySQL',
                            'es'     => 'Versión de MySQL',
                            'fr'     => 'Version de MySQL');
            $text[] = array('key'    => 'DASHBOARD_SERVER_MEMORY_LIMIT',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'Memory limit',
                            'de'     => 'Speicherlimit',
                            'es'     => 'Límite de memoria',
                            'fr'     => 'Limite de mémoire');
            $text[] = array('key'    => 'DASHBOARD_SERVER_MEMORY_LIMIT_WP',
                            'parent' => 'PARENT_DASHBOARD',
                            'text'   => 'WordPress memory limit',
                            'de'     => 'WordPress Speicherlimit',
                            'es'     => 'Límite de memoria de WordPress',
                            'fr'     => 'Limite de mémoire WordPress');
            $text[] = array('key'    => 'DASHBOARD_SERVER_MEMORY_LIMIT_WP_MAX',
                            'parent' => 'PARENT_DASHBOARD',
            ...
            $text[] = array('key'    => 'DASHBOARD_SERVER_MEMORY_LIMIT_WOOCOMMERCE',
                            'parent' => 'PARENT_DASHBOARD',
            ...
            $text[] = array('key'    => 'DASHBOARD_SERVER_CURL_VERSION',
                            'parent' => 'PARENT_DASHBOARD',
