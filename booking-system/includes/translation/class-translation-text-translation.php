...
* Description             : Translation text PHP class.
*/
...
if (!class_exists('DOPBSPTranslationTextTranslation')){
    class DOPBSPTranslationTextTranslation{
        ...
        function translation($text){
            $text[] = array('key'    => 'PARENT_TRANSLATION',
                            'parent' => '',
                            'text'   => 'Translation');

            $text[] = array('key'    => 'TRANSLATION_TITLE',
                            'parent' => 'PARENT_TRANSLATION',
                            'text'   => 'Translation',
                            'de'     => 'Übersetzung',
                            'es'     => 'Traducción',
                            'fr'     => 'Traduction');
            $text[] = array('key'    => 'TRANSLATION_SUBMIT',
                            'parent' => 'PARENT_TRANSLATION',
                            'text'   => 'Manage translation',
                            'de'     => 'Übersetzung verwalten',
                            'es'     => 'Maneje traducción',
                            'fr'     => 'Gérez la traduction');
            $text[] = array('key'    => 'TRANSLATION_LOADED',
                            'parent' => 'PARENT_TRANSLATION',
            ...
            $text[] = array('key'    => 'TRANSLATION_LANGUAGE',
                            'parent' => 'PARENT_TRANSLATION',
                            'text'   => 'Select language',
                            'de'     => 'Sprache wählen',
                            'es'     => 'Lengua escogida',
                            'fr'     => 'Langue de sélection');
            $text[] = array('key'    => 'TRANSLATION_TEXT_GROUP',
                            'parent' => 'PARENT_TRANSLATION',
                            'text'   => 'Select text group',
                            'de'     => 'Textgruppe auswählen',
                            'es'     => 'Seleccione el grupo de texto',
                            'fr'     => 'Choisissez le groupe de texte');
            $text[] = array('key'    => 'TRANSLATION_TEXT_GROUP_ALL',
                            'parent' => 'PARENT_TRANSLATION',
                            'text'   => 'All',
                            'de'     => 'Alle',
                            'es'     => 'Todo',
                            'fr'     => 'Tout');
            $text[] = array('key'    => 'TRANSLATION_SEARCH',
                            'parent' => 'PARENT_TRANSLATION',
                            'text'   => 'Search',
                            'de'     => 'Suche',
                            'es'     => 'Búsqueda',
        ...
        function translationHelp($text){
            $text[] = array('key'    => 'PARENT_TRANSLATION_HELP',
                            'parent' => '',
                            'text'   => 'Translation - Help');

            $text[] = array('key'    => 'TRANSLATION_HELP',
            ...
            $text[] = array('key'    => 'TRANSLATION_SEARCH_HELP',
                            'parent' => 'PARENT_TRANSLATION_HELP',
            ...
            $text[] = array('key'    => 'TRANSLATION_RESET_HELP',
                            'parent' => 'PARENT_TRANSLATION_HELP',
