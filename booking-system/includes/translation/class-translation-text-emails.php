...
if (!class_exists('DOPBSPTranslationTextEmails')){
    class DOPBSPTranslationTextEmails{
        ...
        function emails($text){
            $text[] = array('key'    => 'PARENT_EMAILS',
                            'parent' => '',
                            'text'   => 'Email templates');

            $text[] = array('key'    => 'EMAILS_TITLE',
                            'parent' => 'PARENT_EMAILS',
                            'text'   => 'Email templates',
                            'de'     => 'E-Mail-Vorlagen',
                            'es'     => 'Plantillas de correo electrónico',
                            'fr'     => 'Modèles de courrier électronique');
            $text[] = array('key'    => 'EMAILS_CREATED_BY',
                            'parent' => 'PARENT_EMAILS',
                            'text'   => 'Created by',
                            'de'     => 'Erstellt von',
                            'es'     => 'Creada por',
                            'fr'     => 'Créé par');
            $text[] = array('key'    => 'EMAILS_LOAD_SUCCESS',
                            'parent' => 'PARENT_EMAILS',
            ...
            $text[] = array('key'    => 'EMAILS_NO_EMAILS',
                            'parent' => 'PARENT_EMAILS',
        ...
        function emailsDefault($text){
            $text[] = array('key'    => 'PARENT_EMAILS_DEFAULT',
                            'parent' => '',
                            'text'   => 'Email templates - Default messages');

            $text[] = array('key'    => 'EMAILS_DEFAULT_NAME',
             ...
             */
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_ADMIN_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_ADMIN',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_USER_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_USER',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_WITH_APPROVAL_ADMIN_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
                            'text'   => 'You received a booking request.',
                            'de'     => 'Sie haben eine buchungsanfrage erhalten.',
                            'es'     => 'Recibió una solicitud de reserva.',
                            ...
                            'nl'     => 'U heeft een boekingsaanvraag ontvangen',
                            'pl'     => 'Otrzymałeś nową rezerwację.');
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_WITH_APPROVAL_ADMIN',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_WITH_APPROVAL_USER_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
                            'text'   => 'Your booking request has been sent.',
                            'de'     => 'Ihre Buchungsanfrage wurde versendet.',
                            'es'     => 'Su solicitud de reserva ha sido enviada.',
                            ...
                            'nl'     => 'Uw boekingsverzoek is verzonden.',
                            'pl'     => 'Zamówienie została wysłane.');
            $text[] = array('key'    => 'EMAILS_DEFAULT_BOOK_WITH_APPROVAL_USER',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'EMAILS_DEFAULT_APPROVED_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_APPROVED',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'EMAILS_DEFAULT_CANCELED_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_CANCELED',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
             ...
             */
            $text[] = array('key'    => 'EMAILS_DEFAULT_REJECTED_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_REJECTED',
                            'parent' => 'PARENT_EMAILS_DEFAULT',
        ...
        function emailsEmail($text){
            $text[] = array('key'    => 'PARENT_EMAILS_EMAIL',
                            'parent' => '',
                            'text'   => 'Email templates - Templates');

            $text[] = array('key'    => 'EMAILS_EMAIL_NAME',
                            'parent' => 'PARENT_EMAILS_EMAIL',
                            'text'   => 'Name',
                            'de'     => 'Name',
                            'es'     => 'Nombre',
                            'fr'     => 'Nom');
            $text[] = array('key'    => 'EMAILS_EMAIL_LANGUAGE',
                            'parent' => 'PARENT_EMAILS_EMAIL',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            'es'     => 'Idioma',
            ...
            $text[] = array('key'    => 'EMAILS_EMAIL_TEMPLATE_SELECT_BOOK_WITH_APPROVAL_USER',
                            'parent' => 'PARENT_EMAILS_EMAIL',
            ...
            $text[] = array('key'    => 'EMAILS_EMAIL_TEMPLATE_SELECT_APPROVED',
                            'parent' => 'PARENT_EMAILS_EMAIL',
                            'text'   => 'Approve reservation',
                            'de'     => 'Reservierung genehmigen',
                            'es'     => 'Apruebe reserva',
                            'fr'     => 'Approuvez la réservation');
            $text[] = array('key'    => 'EMAILS_EMAIL_TEMPLATE_SELECT_CANCELED',
                            'parent' => 'PARENT_EMAILS_EMAIL',
                            'text'   => 'Cancel reservation',
                            'de'     => 'Reservierung stornieren',
                            'es'     => 'Cancelar reserva',
                            'fr'     => 'Annulez réservation');
            $text[] = array('key'    => 'EMAILS_EMAIL_TEMPLATE_SELECT_REJECTED',
                            'parent' => 'PARENT_EMAILS_EMAIL',
                            'text'   => 'Reject reservation',
                            'de'     => 'Reservierung ablehnen',
                            'es'     => 'Reserva de desecho',
                            'fr'     => 'Rejetez la réservation');
            $text[] = array('key'    => 'EMAILS_EMAIL_SUBJECT',
                            'parent' => 'PARENT_EMAILS_EMAIL',
                            'text'   => 'Subject',
                            'de'     => 'Betreff',
                            'es'     => 'Sujeto',
                            'fr'     => 'Sujet');
            $text[] = array('key'    => 'EMAILS_EMAIL_MESSAGE',
                            'parent' => 'PARENT_EMAILS_EMAIL',
                            'text'   => 'Message',
                            'de'     => 'Nachricht',
                            'es'     => 'Mensaje',
            ...
            $text[] = array('key'    => 'EMAILS_EMAIL_LOADED',
                            'parent' => 'PARENT_EMAILS_EMAIL',
        ...
        function emailsAddEmail($text){
            $text[] = array('key'    => 'PARENT_EMAILS_ADD_EMAIL',
                            'parent' => '',
                            'text'   => 'Email templates - Add templates');

            $text[] = array('key'    => 'EMAILS_ADD_EMAIL_NAME',
            ...
            $text[] = array('key'    => 'EMAILS_ADD_EMAIL_SUBMIT',
                            'parent' => 'PARENT_EMAILS_ADD_EMAIL',
            ...
            $text[] = array('key'    => 'EMAILS_ADD_EMAIL_ADDING',
                            'parent' => 'PARENT_EMAILS_ADD_EMAIL',
            ...
            $text[] = array('key'    => 'EMAILS_ADD_EMAIL_SUCCESS',
                            'parent' => 'PARENT_EMAILS_ADD_EMAIL',
        ...
        function emailsDeleteEmail($text){
            $text[] = array('key'    => 'PARENT_EMAILS_DELETE_EMAIL',
                            'parent' => '',
                            'text'   => 'Email templates - Delete templates');

            $text[] = array('key'    => 'EMAILS_DELETE_EMAIL_CONFIRMATION',
            ...
            $text[] = array('key'    => 'EMAILS_DELETE_EMAIL_SUBMIT',
                            'parent' => 'PARENT_EMAILS_DELETE_EMAIL',
            ...
            $text[] = array('key'    => 'EMAILS_DELETE_EMAIL_DELETING',
                            'parent' => 'PARENT_EMAILS_DELETE_EMAIL',
            ...
            $text[] = array('key'    => 'EMAILS_DELETE_EMAIL_SUCCESS',
                            'parent' => 'PARENT_EMAILS_DELETE_EMAIL',
        ...
        function emailsHelp($text){
            $text[] = array('key'    => 'PARENT_EMAILS_HELP',
                            'parent' => '',
                            'text'   => 'Email templates - Help');

            $text[] = array('key'    => 'EMAILS_HELP',
            ...
            $text[] = array('key'    => 'EMAILS_ADD_EMAIL_HELP',
                            'parent' => 'PARENT_EMAILS_HELP',
             ...
             * Email help.
             */
            $text[] = array('key'    => 'EMAILS_EMAIL_HELP',
                            'parent' => 'PARENT_EMAILS_HELP',
            ...
            $text[] = array('key'    => 'EMAILS_EMAIL_NAME_HELP',
                            'parent' => 'PARENT_EMAILS_HELP',
            ...
            $text[] = array('key'    => 'EMAILS_EMAIL_LANGUAGE_HELP',
                            'parent' => 'PARENT_EMAILS_HELP',
            ...
            $text[] = array('key'    => 'EMAILS_EMAIL_TEMPLATE_SELECT_HELP',
                            'parent' => 'PARENT_EMAILS_HELP',
