...
if (!class_exists('DOPBSPTranslationTextWidgets')){
    class DOPBSPTranslationTextWidgets{
        ...
        function widget($text){
            ...
            $text[] = array('key'    => 'WIDGET_TITLE_LABEL',
                            'parent' => 'PARENT_WIDGET',
                            'text'   => 'Title:',
                            'de'     => 'Titel:',
                            'es'     => 'Título:',
                            'fr'     => 'Titre');
            $text[] = array('key'    => 'WIDGET_SELECTION_LABEL',
                            'parent' => 'PARENT_WIDGET',
                            'text'   => 'Select action:',
                            'de'     => 'Aktion auswählen:',
                            'es'     => 'Acción escogida:',
                            'fr'     => 'Action de sélection :');
            $text[] = array('key'    => 'WIDGET_SELECTION_ADD_CALENDAR',
                            'parent' => 'PARENT_WIDGET',
                            'text'   => 'Add calendar',
                            'de'     => 'Kalender hinzufügen',
                            'es'     => 'Añada calendario',
                            'fr'     => 'Ajoutez le calendrier');
            $text[] = array('key'    => 'WIDGET_SELECTION_ADD_SIDEBAR',
                            'parent' => 'PARENT_WIDGET',
            ...
            $text[] = array('key'    => 'WIDGET_ID_LABEL',
                            'parent' => 'PARENT_WIDGET',
            ...
            $text[] = array('key'    => 'WIDGET_NO_CALENDARS',
                            'parent' => 'PARENT_WIDGET',
                            'text'   => 'No calendars.',
                            'de'     => 'Keine Kalender.',
                            'es'     => 'Ningunos calendarios.',
                            'fr'     => 'Aucun calendrier.');
            $text[] = array('key'    => 'WIDGET_LANGUAGE_LABEL',
                            'parent' => 'PARENT_WIDGET',
