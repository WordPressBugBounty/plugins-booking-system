...
if (!class_exists('DOPBSPFrontEnd')){
    class DOPBSPFrontEnd{
        ...
        function shortcode($atts){
            ...
            extract(shortcode_atts(array('class' => 'dopbsp'),
                                   $atts));
            ...
            $atts['lang'] = substr($atts['lang'],
                                   0,
                                   2);

            if (!array_key_exists('woocommerce',
                                  $atts)){
                $atts['woocommerce'] = 'false';
            }

            if (!array_key_exists('woocommerce_add_to_cart',
                                  $atts)){
                $atts['woocommerce_add_to_cart'] = 'false';
            }

            if (!array_key_exists('woocommerce_position',
                                  $atts)){
                $atts['woocommerce_position'] = 'summary';
            }

            if (!array_key_exists('woocommerce_product_id',
                                  $atts)){
