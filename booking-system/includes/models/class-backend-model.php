...
* File Version            : 1.0
* Created / Last Modified : 14 March 2015
* Author                  : Dot on Paper
...
if (!class_exists('DOPBSPBackEndModel')){
    class DOPBSPBackEndModel extends DOPBSPBackEndModels{
        ...
        function add(){
            ...
            $wpdb->insert($DOPBSP->tables->models,
        ...
        function edit(){
            ...
            if ($field == 'label'
                ...
                $translation = json_decode($field == 'label'
                                                   ? $model_data->translation
                                                   : $model_data->translation_calendar);
            ...
            $wpdb->update($DOPBSP->tables->models,
                          array($field => $value),
                          array('id' => $id));
        ...
        function delete(){
             ...
             * Delete model.
             */
            $wpdb->delete($DOPBSP->tables->models,
                          array('id' => $id));
