...
if (!class_exists('DOPBSPPayPalTranslationText')){
    class DOPBSPPayPalTranslationText{
        ...
        function settings($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'parent' => '',
                            'text'   => 'Settings - PayPal');

            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'text'   => 'PayPal',
                            'de'     => 'PayPal',
                            'es'     => 'PayPal',
                            'fr'     => 'PayPal');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'text'   => 'Enable PayPal payment',
                            'de'     => 'PayPal-Zahlung aktivieren',
                            'es'     => 'Permita pago PayPal',
                            'fr'     => 'Permettez paiement PayPal');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_CREDIT_CARD',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_USERNAME',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SANDBOX_PASSWORD',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SANDBOX_SIGNATURE',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_ENABLED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'text'   => 'Enable refunds',
                            'de'     => 'Rückerstattungen aktivieren',
                            'es'     => 'Permita reembolsos',
                            'fr'     => 'Permettez remboursements');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_VALUE',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'text'   => 'Refund value',
                            'de'     => 'Rückerstattungswert',
                            'es'     => 'Valor de reembolso',
                            'fr'     => 'Valeur de remboursement');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_TYPE',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'text'   => 'Refund type',
                            'de'     => 'Art der Erstattung',
                            'es'     => 'Tipo de reembolso',
                            'fr'     => 'Type de remboursement');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_TYPE_FIXED',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'text'   => 'Fixed',
                            'de'     => 'Fest',
                            'es'     => 'Fijo',
                            'fr'     => 'Fixé');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_TYPE_PERCENT',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
                            'text'   => 'Percent',
                            'de'     => 'Prozent',
                            'es'     => 'Por ciento',
                            'fr'     => 'Pour cent');
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REDIRECT',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
             ...
             * Notifications
             */
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SEND_ADMIN',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SEND_USER',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL',
        ...
        function settingsHelp($text){
            $text[] = array('key'    => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
                            'parent' => '',
                            'text'   => 'Settings - PayPal - Help');

            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_ENABLED_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_CREDIT_CARD_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_USERNAME_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_PASSWORD_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SIGNATURE_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SANDBOX_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SANDBOX_USERNAME_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SANDBOX_PASSWORD_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SANDBOX_SIGNATURE_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_ENABLED_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_VALUE_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REFUND_TYPE_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_REDIRECT_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
             ...
             * Notifications
             */
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SEND_ADMIN_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
            ...
            $text[] = array('key'    => 'SETTINGS_PAYMENT_GATEWAYS_PAYPAL_SEND_USER_HELP',
                            'parent' => 'PARENT_SETTINGS_PAYMENT_GATEWAYS_PAYPAL_HELP',
         ...
         */
        function order($text){
            $text[] = array('key'    => 'PARENT_ORDER_PAYMENT_GATEWAYS_PAYPAL',
                            'parent' => '',
                            'text'   => 'Order - PayPal');
            /*
             * Payment method.
             */
            $text[] = array('key'      => 'ORDER_PAYMENT_METHOD_PAYPAL',
             ...
             * Front end.
             */
            $text[] = array('key'      => 'ORDER_PAYMENT_GATEWAYS_PAYPAL',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_GATEWAYS_PAYPAL_SUCCESS',
                            'parent'   => 'PARENT_ORDER_PAYMENT_GATEWAYS_PAYPAL',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_GATEWAYS_PAYPAL_CANCEL',
                            'parent'   => 'PARENT_ORDER_PAYMENT_GATEWAYS_PAYPAL',
                            ...
                            'location' => 'all');
            $text[] = array('key'      => 'ORDER_PAYMENT_GATEWAYS_PAYPAL_ERROR',
                            'parent'   => 'PARENT_ORDER_PAYMENT_GATEWAYS_PAYPAL',
         ...
         */
        function email($text){
            $text[] = array('key'    => 'PARENT_EMAILS_DEFAULT_PAYPAL',
                            'parent' => '',
                            'text'   => 'Email templates - PayPal default messages');
            /*
             * Admin
             */
            $text[] = array('key'    => 'EMAILS_EMAIL_TEMPLATE_SELECT_PAYPAL_ADMIN',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_PAYPAL_ADMIN_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT_PAYPAL',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_PAYPAL_ADMIN',
                            'parent' => 'PARENT_EMAILS_DEFAULT_PAYPAL',
             ...
             * User
             */
            $text[] = array('key'    => 'EMAILS_EMAIL_TEMPLATE_SELECT_PAYPAL_USER',
                            'parent' => 'PARENT_EMAILS_DEFAULT_PAYPAL',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_PAYPAL_USER_SUBJECT',
                            'parent' => 'PARENT_EMAILS_DEFAULT_PAYPAL',
            ...
            $text[] = array('key'    => 'EMAILS_DEFAULT_PAYPAL_USER',
                            'parent' => 'PARENT_EMAILS_DEFAULT_PAYPAL',
         ...
         */
        function sms($text){
            $text[] = array('key'    => 'PARENT_SMSES_DEFAULT_PAYPAL',
                            'parent' => '',
                            'text'   => 'SMS templates - PayPal default messages');
            /*
             * Admin
             */
            $text[] = array('key'    => 'SMSES_SMS_TEMPLATE_SELECT_PAYPAL_ADMIN',
                            'parent' => 'PARENT_SMSES_DEFAULT_PAYPAL',
                            'text'   => 'PayPal admin notification',
                            'de'     => 'PayPal Admin Benachrichtigung',
                            'es'     => 'PayPal notificación de admón',
                            'fr'     => 'PayPal notification d<<single-quote>>administration');
            $text[] = array('key'    => 'SMSES_DEFAULT_PAYPAL_ADMIN_SUBJECT',
                            'parent' => 'PARENT_SMSES_DEFAULT_PAYPAL',
                            'text'   => 'You received a booking request.',
                            'de'     => 'Sie haben eine Buchungsanfrage erhalten.',
                            'es'     => 'Recibió una solicitud de reserva.',
                            'fr'     => 'Vous avez reçu une demande de réservation.');
            $text[] = array('key'    => 'SMSES_DEFAULT_PAYPAL_ADMIN',
                            'parent' => 'PARENT_SMSES_DEFAULT_PAYPAL',
             ...
             * User
             */
            $text[] = array('key'    => 'SMSES_SMS_TEMPLATE_SELECT_PAYPAL_USER',
                            'parent' => 'PARENT_SMSES_DEFAULT_PAYPAL',
                            'text'   => 'PayPal user notification',
                            'de'     => 'PayPal Benutzerbenachrichtigung',
                            'es'     => 'PayPal notificación de usuario',
                            'fr'     => 'Notification d<<single-quote>>utilisateur de PayPal');
            $text[] = array('key'    => 'SMSES_DEFAULT_PAYPAL_USER_SUBJECT',
                            'parent' => 'PARENT_SMSES_DEFAULT_PAYPAL',
                            'text'   => 'Your booking request has been sent.',
                            'de'     => 'Ihre Buchungsanfrage wurde gesendet.',
                            'es'     => 'Su solicitud de reserva ha sido enviada.',
                            'fr'     => 'Votre demande de réservation a été envoyée.');
            $text[] = array('key'    => 'SMSES_DEFAULT_PAYPAL_USER',
