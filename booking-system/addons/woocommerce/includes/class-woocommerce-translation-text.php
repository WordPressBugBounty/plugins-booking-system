...
if (!class_exists('DOPBSPWooCommerceTranslationText')){
    class DOPBSPWooCommerceTranslationText{
        ...
        function woocommerce($text){
            $text[] = array('key'    => 'PARENT_WOOCOMMERCE',
                            'parent' => '',
                            'text'   => 'WooCommerce');
            /*
             * Back end tab.
             */
            $text[] = array('key'    => 'WOOCOMMERCE_TAB',
            ...
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_CALENDAR',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'Calendar',
                            'de'     => 'Kalender',
                            'es'     => 'Calendario',
                            'fr'     => 'Calendrier');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_CALENDAR_NO_CALENDARS',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'No calendars.',
                            'de'     => 'Keine Kalender.',
                            'es'     => 'Ningunos calendarios',
                            'fr'     => 'Aucun calendrier');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_CALENDAR_SELECT',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'Select calendar',
                            'de'     => 'Wählen Sie den Kalender aus',
                            'es'     => 'Seleccione un calendario',
                            'fr'     => 'Choisissez un calendrier');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_LANGUAGE',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'Language',
                            'de'     => 'Sprache',
                            ...
                            'fr' => 'Langue');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_POSITION',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'Position',
                            'de'     => 'Position',
                            'es'     => 'Posición',
                            'fr'     => 'Position');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_POSITION_SUMMARY',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'Summary',
                            'de'     => 'Zusammenfassung',
                            'es'     => 'Resumen',
                            'fr'     => 'Résumé');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_POSITION_TABS',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'Tabs',
                            'de'     => 'Registerkarten',
                            'es'     => 'Etiquetas',
                            'fr'     => 'Onglets');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_POSITION_SUMMARY_AND_TABS',
                            'parent' => 'PARENT_WOOCOMMERCE',
                            'text'   => 'Summary & Tabs',
                            'de'     => 'Zusammenfassung & Registerkarten',
                            'es'     => 'Resumen y Etiquetas',
                            'fr'     => 'Résumé et Languettes');
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_ADD_TO_CART',
                            'parent' => 'PARENT_WOOCOMMERCE',
             ...
             * Front end.
             */
            $text[] = array('key'      => 'WOOCOMMERCE_VIEW_AVAILABILITY',
                            'parent'   => 'PARENT_WOOCOMMERCE',
            ...
            $text[] = array('key'      => 'WOOCOMMERCE_STARTING_FROM',
                            'parent'   => 'PARENT_WOOCOMMERCE',
                            'text'     => 'Starting from',
                            'de'       => 'Ausgehend von',
                            'location' => 'woocommerce_frontend');
            $text[] = array('key'      => 'WOOCOMMERCE_ADD_TO_CART',
                            'parent'   => 'PARENT_WOOCOMMERCE',
                            'text'     => 'Add to cart',
                            ...
                            'location' => 'woocommerce_frontend');
            $text[] = array('key'      => 'WOOCOMMERCE_TABS',
                            'parent'   => 'PARENT_WOOCOMMERCE',
                            'text'     => 'Book',
                            'de'       => 'Buchen',
                            'es'       => '',
             ...
             * Messages
             */
            $text[] = array('key'      => 'WOOCOMMERCE_VIEW_CART',
                            'parent'   => 'PARENT_CART',
                            'text'     => 'View cart',
                            ...
                            'fr'       => 'réserver',
                            'location' => 'woocommerce_frontend');
            $text[] = array('key'    => 'WOOCOMMERCE_SUCCESS',
                            'parent' => 'PARENT_CART',
                            ...
                            'location' => 'woocommerce_frontend');
            $text[] =
                    array('key'      => 'WOOCOMMERCE_UNAVAILABLE',
                          'parent'   => 'PARENT_CART',
                          ...
                          'location' => 'woocommerce_frontend');
            $text[] = array('key'      => 'WOOCOMMERCE_OVERLAP',
                            'parent'   => 'PARENT_CART',
                            ...
                            'location' => 'woocommerce_frontend');
            $text[] = array('key'      => 'WOOCOMMERCE_DELETED',
                            'parent'   => 'PARENT_CART',
        ...
        function woocommerceHelp($text){
            $text[] = array('key'    => 'PARENT_WOOCOMMERCE_HELP',
                            'parent' => '',
                            'text'   => 'WooCommerce - Help');

            $text[] = array('key'    => 'WOOCOMMERCE_TAB_CALENDAR_HELP',
            ...
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_LANGUAGE_HELP',
                            'parent' => 'PARENT_WOOCOMMERCE_HELP',
            ...
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_POSITION_HELP',
                            'parent' => 'PARENT_WOOCOMMERCE_HELP',
            ...
            $text[] = array('key'    => 'WOOCOMMERCE_TAB_ADD_TO_CART_HELP',
                            'parent' => 'PARENT_WOOCOMMERCE_HELP',
