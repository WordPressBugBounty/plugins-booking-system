            ...
            if ($reservation->fees_price>0){
                ...
                for ($i = 0; $i<count($fees); $i++){
                    ...
                    if ($fee->included == 'true'){
                        array_push($value,
                                   '<span class="dopbsp-info-price">'.$DOPBSP->text('FEES_FRONT_END_INCLUDED').'</span>');
                    }
                    else{
                        array_push($value,
                                   '<span class="dopbsp-info-price">'.$fee->operation.'&nbsp;');
                        array_push($value,
