        ...
        private function add(){
            ...
            if (count($this->intervals)>0){
                ...
                foreach ($this->intervals as $interval){
                     ...
                     */
                    $this->settings->days_morning_check_out == 'true'
                            ? $interval_end = date('Y-m-d H:i:s',
                                                   strtotime('+1 day',
                                                             strtotime($interval_end)))
                            : '';
        ...
        private function available($day){
            ...
            if (isset($this->schedule[$day])){
                ...
                if ($day_data->available == 0){
                    ...
                    $this->price_curr = $day_data->promo != 0
                            ? $day_data->promo
                            : $day_data->price;
            ...
            if ($this->default->available == 0){
                ...
                $this->price_curr = $this->default->promo != 0
                        ? $this->default->promo
                        : $this->default->price;
                return true;
            }
            ...
            if ($this->default->available != 0){
                ...
                if ($this->interval_started){
                    ...
                    $this->interval_start = date('Y-m-d',
                                                 strtotime('+1 day',
                                                           strtotime($this->day_curr))).' 00:00:00';
                    $this->interval_end = '9999-01-01 23:59:59';
                ...
                if ($this->interval_price>-1){
                    ...
                    $this->interval_price_start = date('Y-m-d',
                                                       strtotime('+1 day',
                                                                 strtotime($this->day_curr))).' 00:00:00';
                    $this->interval_price_end = '9999-01-01 23:59:59';
                    $this->interval_price = $this->default->promo != 0
                            ? $this->default->promo
                            : $this->default->price;
                }
            }
